if modifier_courier_fx_ambient_47 == nil then
	modifier_courier_fx_ambient_47 = class({})
end

local public = modifier_courier_fx_ambient_47
...
function public:OnCreated(params)
	if IsClient() then
		local iParticleID = ParticleManager:CreateParticle("particles/econ/courier/courier_oculopus/courier_oculopus_ambient.vpcf", PATTACH_ABSORIGIN, self:GetParent())
