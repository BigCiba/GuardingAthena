if modifier_courier_fx_ambient_5 == nil then
	modifier_courier_fx_ambient_5 = class({})
end

local public = modifier_courier_fx_ambient_5
...
function public:OnCreated(params)
	if IsClient() then
		local iParticleID = ParticleManager:CreateParticle("particles/econ/courier/courier_axolotl_ambient/courier_axolotl_ambient_lvl4.vpcf", PATTACH_CUSTOMORIGIN, self:GetParent())
