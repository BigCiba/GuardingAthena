if modifier_courier_fx_ambient_55 == nil then
	modifier_courier_fx_ambient_55 = class({})
end

local public = modifier_courier_fx_ambient_55
...
function public:OnCreated(params)
	if IsClient() then
		local iParticleID = ParticleManager:CreateParticle("particles/econ/courier/courier_smeevil/courier_smeevil_bird_ambient.vpcf", PATTACH_RENDERORIGIN_FOLLOW, self:GetParent())
