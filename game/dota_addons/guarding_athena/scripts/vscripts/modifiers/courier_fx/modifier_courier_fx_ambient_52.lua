if modifier_courier_fx_ambient_52 == nil then
	modifier_courier_fx_ambient_52 = class({})
end

local public = modifier_courier_fx_ambient_52
...
function public:OnCreated(params)
	if IsClient() then
		local iParticleID = ParticleManager:CreateParticle("particles/econ/courier/courier_shagbark/courier_shagbark_ambient.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetParent())
