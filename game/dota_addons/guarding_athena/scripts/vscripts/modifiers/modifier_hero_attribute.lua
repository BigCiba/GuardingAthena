...
function public:OnCreated(params)
	...
	hParent.AddBonusIntelligenceGain = function (hParent, iCount) self.BonusIntelligenceGain = self.BonusIntelligenceGain + iCount end
	...
	hParent.SetBonusIntelligenceGain = function (hParent, iCount) self.BonusIntelligenceGain = iCount end
	...
	hParent.GetBonusIntelligenceGain = function (hParent) return self.BonusIntelligenceGain end
...
function public:OnDestroy()
	...
	hParent.AddBonusIntelligenceGain = nil
	...
	hParent.SetBonusIntelligenceGain = nil
	...
	hParent.GetBonusIntelligenceGain = nil
