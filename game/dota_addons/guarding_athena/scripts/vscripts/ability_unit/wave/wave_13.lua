function GolemSplit( t )
    ...
    for i=1,2 do
        PrecacheUnitByNameAsync("wave_11",function()
            local unit = CreateUnitByName("wave_11", caster_location + Vector(RandomInt(-50, 50),RandomInt(-50, 50),0), true, nil, nil, DOTA_TEAM_BADGUYS )
