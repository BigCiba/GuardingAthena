...
function Spawn( entityKeyValues )
	...
	tAbility = {
		{hAbility = thisEntity:FindAbilityByName( "pet_44_1" ), fCondition = EnemyCount, args = {1}, fAction = CastNoTarget},
		{hAbility = thisEntity:FindAbilityByName( "pet_44_2" ), fCondition = true, fAction = CastNoTarget},
	}
