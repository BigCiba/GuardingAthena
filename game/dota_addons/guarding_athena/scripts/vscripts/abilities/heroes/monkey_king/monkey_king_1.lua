...
function monkey_king_1:OnSpellStart()
	...
	local iParticleID = ParticleManager:CreateParticle("particles/heroes/monkey_king/stick_wind.vpcf", PATTACH_ABSORIGIN_FOLLOW, hCaster)
	...
	hCaster:Dash(vDirection, flDistance, 150, 0.3, function()
		...
		local iParticleID = ParticleManager:CreateParticle("particles/heroes/monkey_king/stick_wind_strike.vpcf", PATTACH_ABSORIGIN_FOLLOW, hCaster)
