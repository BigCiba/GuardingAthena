LinkLuaModifier("modifier_pet_49_1", "abilities/pets/pet_49_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_pet_49_1_buff", "abilities/pets/pet_49_1.lua", LUA_MODIFIER_MOTION_NONE)

--Abilities
if pet_49_1 == nil then
	pet_49_1 = class({})
end
...
---------------------------------------------------------------------
--Modifiers
if modifier_pet_49_1 == nil then
	modifier_pet_49_1 = class({}, nil, ModifierBasic)
end
function modifier_pet_49_1:IsHidden()
	return true
end
...
---------------------------------------------------------------------
if modifier_pet_49_1_buff == nil then
	modifier_pet_49_1_buff = class({}, nil, ModifierBasic)
end
...
function modifier_pet_49_1_buff:OnDestroy()
	if IsServer() then
	end
