...
function Spawner:AutoSpawn()
	...
	self.spawnerTimer = GameTimer(0, function()
		if self.iTime >= self.spawnInterval and self.gameRound <= self.maxWave then
			self.iTime = 0
...
-- 暂停刷怪
function Spawner:TogglePauseSpawn()
