...
function modifier_juggernaut_1_buff:OnCreated(params)
    self.blade_fury_damage_tick = self:GetAbility():GetSpecialValueFor("blade_fury_damage_tick")
    self.blade_fury_radius = self:GetAbility():GetSpecialValueFor("blade_fury_radius")
