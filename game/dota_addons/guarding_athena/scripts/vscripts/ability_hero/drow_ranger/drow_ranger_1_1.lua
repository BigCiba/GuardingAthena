LinkLuaModifier("modifier_drow_ranger_1_1", "ability_hero/drow_ranger/drow_ranger_1_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_1_1_thinker", "ability_hero/drow_ranger/drow_ranger_1_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_1_1_debuff", "ability_hero/drow_ranger/drow_ranger_1_1.lua", LUA_MODIFIER_MOTION_NONE)
