...
ATTRIBUTE_STRENGTH_HP_REGEN = 0.09 -- 力量增加生命回复值
ATTRIBUTE_AGILITY_ATTACK_SPEED = 1 -- 敏捷增加攻速
ATTRIBUTE_AGILITY_ARMOR = 0.16667 -- 敏捷增加护甲
...
HERO_SELECTION_TIME = IsInToolsMode() and 9999 or 20
-- 刷新排除技能
...
function public:init(bReload)
	...
	CustomNetTables:SetTableValue("common", "settings", {
		...
		ATTRIBUTE_AGILITY_ARMOR = ATTRIBUTE_AGILITY_ARMOR,
		...
		PHYSICAL_ARMOR_FACTOR = PHYSICAL_ARMOR_FACTOR,
		MAGICAL_ARMOR_FACTOR = MAGICAL_ARMOR_FACTOR,
		HERO_MAX_LEVEL = MAX_LEVEL,
		HERO_XP_PER_LEVEL_TABLE = XP_PER_LEVEL_TABLE,
	})
	-- 玩家可买物品最大数目，不限制
