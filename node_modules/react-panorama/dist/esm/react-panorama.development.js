 ...
 * @license MIT
 */
import require$$1, { useEffect, useState } from 'react';
...
function useNetTableValues(name) {
    const [values, setValue] = useState(() => CustomNetTables.GetAllTableValues(name).reduce((accumulator, pair) => (Object.assign(Object.assign({}, accumulator), { [pair.key]: pair.value })), {}));
    useEffect(() => {
        const listener = CustomNetTables.SubscribeNetTableListener(name, (_, eventKey, eventValue) => {
...
export { createPortal, render, useGameEvent, useNetTableKey, useNetTableValues, useRegisterForUnhandledEvent };
