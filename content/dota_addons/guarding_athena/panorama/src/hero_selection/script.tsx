	...
	return (
		<Panel className="PlayerContainer">
			<Panel className="PlayerBackground">
				<Panel onload={(panel: Panel) => { panel.BLoadLayoutSnippet("AvatarImage"); panel?.GetChild(0)?.steamid = steamid; }} />
			...
			<Panel className="MainSelectionPage">
				...
				<Panel className="MainPage">
					...
					<Panel className="HeroListAndChat">
						...
						<GenericPanel type="DOTAChat" id="Chat" class="PreGameChat" chatstyle="hudpregame" />
					</Panel>
				</Panel>
			</Panel>
		</>
