...
/***/ "./elements/AbilityDetails/AbilityDetails.jsx":
/*!****************************************************!*\
  !*** ./elements/AbilityDetails/AbilityDetails.jsx ***!
  \****************************************************/
/*! namespace exports */
/*! export AbilityDetails [provided] [no usage info] [missing usage info prevents renaming] */
...
/* harmony export */   "AbilityDetails": () => /* binding */ AbilityDetails
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "../../../../../node_modules/react/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./elements/AbilityDetails/utils.js");
...
function AbilityDetails(_ref) {
  var _ref$abilityname = _ref.abilityname,
      abilityname = _ref$abilityname === void 0 ? "" : _ref$abilityname,
      _ref$entityindex = _ref.entityindex,
      entityindex = _ref$entityindex === void 0 ? -1 : _ref$entityindex,
      _ref$inventoryslot = _ref.inventoryslot,
      inventoryslot = _ref$inventoryslot === void 0 ? -1 : _ref$inventoryslot,
      _ref$level = _ref.level,
      level = _ref$level === void 0 ? -1 : _ref$level,
      _ref$mode = _ref.mode,
      mode = _ref$mode === void 0 ? "normal" : _ref$mode,
      _ref$showextradescrip = _ref.showextradescription,
      showextradescription = _ref$showextradescrip === void 0 ? false : _ref$showextradescrip,
      other = _objectWithoutProperties(_ref, ["abilityname", "entityindex", "inventoryslot", "level", "mode", "showextradescription"]);
  ...
  var bShowExtra = showextradescription;
  var tAbility = CustomUIConfig.AbilitiesKv[abilityname];
  var tItem = CustomUIConfig.ItemsKv[abilityname];
  var tData = tAbility || tItem;
  var bIsItem = tData != tAbility && tData == tItem;
  ...
  var iLevel = iAbilityIndex != -1 ? Abilities.GetLevel(iAbilityIndex) : level;
  var iMaxLevel = iAbilityIndex != -1 ? Abilities.GetMaxLevel(iAbilityIndex) : -1;
  var iUpgradeLevel = iAbilityIndex != -1 ? Abilities.GetHeroLevelRequiredToUpgrade(iAbilityIndex) : -1;
  var iAbilityLearnResult = iAbilityIndex != -1 ? Abilities.CanAbilityBeUpgraded(iAbilityIndex) : -1;

  if (bIsItem) {
    iLevel = iAbilityIndex == -1 ? tData.ItemBaseLevel || 1 : iLevel;
    iMaxLevel = iAbilityIndex == -1 ? tData.MaxUpgradeLevel || 0 : iMaxLevel;
    var bIsConsumable = tData.ItemQuality == "consumable";
    toggleClass['Consumable'] = bIsConsumable;
    var iItemCost = iAbilityIndex != -1 ? Items.GetCost(iAbilityIndex) : GetItemCost(abilityname);
    var bIsSellable = iAbilityIndex != -1 ? Items.IsSellable(iAbilityIndex) : false;
    ...
    if (toggleClass['ShowSellPrice']) {
      var fPurchaseTime = Items.GetPurchaseTime(iAbilityIndex);
      var bOriginalPrice = Game.GetGameTime() <= fPurchaseTime + 10;
      ...
      var fTime = Game.GetGameTime() - fPurchaseTime;
      var sStr = "";

      if (fTime <= 10) {
        fTime = parseInt((10 - fTime).toFixed(0));
        var sMinute = Math.floor(fTime / 60).toString();
        var sSecond = (fTime % 60).toString();
  ...
  var iBehavior = iAbilityIndex != -1 ? Abilities.GetBehavior(iAbilityIndex) : SBehavior2IBehavior(tData.AbilityBehavior || "");
  var sCastType = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getCastType)(iBehavior);
  dialogVariables['casttype'] = $.Localize(sCastType);
  var iTeam = iAbilityIndex != -1 ? Abilities.GetAbilityTargetTeam(iAbilityIndex) : STeam2ITeam(tData.AbilityUnitTargetTeam || "");
  var iType = iAbilityIndex != -1 ? Abilities.GetAbilityTargetType(iAbilityIndex) : SType2IType(tData.AbilityUnitTargetType || "");
  var sTargetType = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getTargetType)(iTeam, iType);
  dialogVariables['targettype'] = $.Localize(sTargetType);
  var iDamageType = iAbilityIndex != -1 ? Abilities.GetAbilityDamageType(iAbilityIndex) : SDamageType2IDamageType(tData.AbilityUnitDamageType || "");
  var sDamageType = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getDamageType)(iDamageType);
  dialogVariables['damagetype'] = $.Localize(sDamageType);
  var iSpellImmunityType = SSpellImmunityType2ISpellImmunityType(tData.SpellImmunityType || "");
  var sSpellImmunity = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getSpellImmunity)(iSpellImmunityType);
  dialogVariables['spellimmunity'] = $.Localize(sSpellImmunity);
  var sSpellDispellableType = tData.SpellDispellableType || "";
  var sDispelType = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getDispelType)(sSpellDispellableType);
  dialogVariables['dispeltype'] = $.Localize(sDispelType);
  var bIsActive = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.isActive)(iBehavior);
  var iActiveDescriptionLine = tData.ActiveDescriptionLine || 1;
  var sLore = "DOTA_Tooltip_ability_" + abilityname + "_Lore";
  ...
  if (toggleClass['ScepterUpgradable']) {
    var sScepterUpgradeDescription = $.Localize("DOTA_Tooltip_ability_" + abilityname + "_aghanim_description");

    if (sScepterUpgradeDescription != "DOTA_Tooltip_ability_" + abilityname + "_aghanim_description") {
      sScepterUpgradeDescription = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.replaceValues)(sScepterUpgradeDescription, showextradescription, abilityname, iLevel, entityindex);
      dialogVariables['scepter_upgrade_description'] = sScepterUpgradeDescription;
    }
  }

  var sExtraDescription = "";
  var iMaxNote = 13;

  for (var i = 0; i < iMaxNote; i++) {
    var sNote = "DOTA_Tooltip_ability_" + abilityname + "_note" + i;
  ...
  if (bIsItem) {
    var sItemDispelType = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getItemDispelType)(sSpellDispellableType);
  ...
  sExtraDescription = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.replaceValues)(sExtraDescription, showextradescription, abilityname, iLevel, entityindex);
  dialogVariables['extradescription'] = sExtraDescription; // 属性

  var aValueNames = GetSpecialNames(abilityname, entityindex);
  var sAttributes = "";
  var sExtraAttributes = "";

  for (var _i2 = 0; _i2 < aValueNames.length; _i2++) {
    var sValueName = aValueNames[_i2];
    var bRequiresScepter = (GetSpecialValueProperty(abilityname, sValueName, "RequiresScepter", entityindex) || 0) == 1;

    if (bRequiresScepter && entityindex != -1 && !Entities.HasScepter(entityindex)) {
      continue;
    }

    var sValueDescription = "DOTA_Tooltip_ability_" + abilityname + "_" + sValueName;
    ...
    var sValueLocalize = $.Localize(sValueDescription);

    if (sValueLocalize != sValueDescription) {
      var bHasPercentSign = sValueLocalize.search(/%/g) == 0;

      if (bHasPercentSign) {
        sValueLocalize = sValueLocalize.substr(1);
      }

      var bHasPlusSign = sValueLocalize.search(/\+/g) == 0;
      ...
      if (bHasPlusSign) {
        ...
        sAttributes = sAttributes + " ";
        var aVariables = sValueLocalize.match(/\$(.+?)\b/g);

        if (aVariables) {
          var _iterator = _createForOfIteratorHelper(aVariables),
              _step;

          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var block = _step.value;
              var sVariable = block.substr(1);
              var sVariableLocalize = $.Localize("dota_ability_variable_" + sVariable);
  ...
  sAttributes = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.replaceValues)(sAttributes, showextradescription, abilityname, bIsItem ? iLevel : iLevel != -1 ? iLevel : 0, entityindex);
  dialogVariables['attributes'] = sAttributes;
  sExtraAttributes = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.replaceValues)(sExtraAttributes, showextradescription, abilityname, bIsItem ? iLevel : iLevel != -1 ? iLevel : 0, entityindex);
  dialogVariables['extra_attributes'] = sExtraAttributes; // TODO: 冷却和魔耗的无效数据待处理

  var fCurrentCooldown = iAbilityIndex != -1 ? Abilities.GetLevelCooldown(iAbilityIndex) : 0;
  fCurrentCooldown = CalcSpecialValueUpgrade(entityindex, abilityname, "cooldown", fCurrentCooldown);
  var fCurrentManaCost = iAbilityIndex != -1 ? Abilities.GetLevelManaCost(iAbilityIndex) : 0;
  fCurrentManaCost = CalcSpecialValueUpgrade(entityindex, abilityname, "mana_cost", fCurrentManaCost);
  var aCooldowns = StringToValues(tData.AbilityCooldown || "");

  for (var _i3 = 0; _i3 < Math.max(aCooldowns.length, iMaxLevel); _i3++) {
    var v = iAbilityIndex != -1 ? Abilities.GetLevelCooldown(iAbilityIndex, _i3) : aCooldowns[_i3] || 0;
    aCooldowns[_i3] = CalcSpecialValueUpgrade(entityindex, abilityname, "cooldown", v);
  }

  aCooldowns = SimplifyValuesArray(aCooldowns);
  var aManaCosts = StringToValues(tData.AbilityManaCost || "");

  for (var _i4 = 0; _i4 < Math.max(aManaCosts.length, iMaxLevel); _i4++) {
    var _v = iAbilityIndex != -1 ? Abilities.GetLevelManaCost(iAbilityIndex, _i4) : aManaCosts[_i4] || 0;

    aManaCosts[_i4] = CalcSpecialValueUpgrade(entityindex, abilityname, "mana_cost", _v);
  }
  ...
  var fCooldownReduction = entityindex != -1 ? Entities.GetCooldownReduction(entityindex) * 0.01 : 0;
  fCurrentCooldown = Float(fCurrentCooldown * (1 - fCooldownReduction * 0.01)); // 冷却时间

  var sCooldownDescription = "";

  if (!(aCooldowns.length == 0 || aCooldowns.length == 1 && aCooldowns[0] == 0)) {
    for (var _level = 0; _level < aCooldowns.length; _level++) {
      var value = Float(aCooldowns[_level] * (1 - fCooldownReduction * 0.01));

      if (sCooldownDescription != "") {
        sCooldownDescription = sCooldownDescription + " / ";
      }

      var sValue = Round(Math.abs(value), 2) + "";

      if (iLevel != -1 && _level + 1 == Math.min(iLevel, aCooldowns.length)) {
  ...
  var sManaCostDescription = "";

  if (!(aManaCosts.length == 0 || aManaCosts.length == 1 && aManaCosts[0] == 0)) {
    for (var _level2 = 0; _level2 < aManaCosts.length; _level2++) {
      var _value = aManaCosts[_level2];

      if (sManaCostDescription != "") {
        sManaCostDescription = sManaCostDescription + " / ";
      }

      var _sValue = Round(Math.abs(_value)) + "";

      if (iLevel != -1 && _level2 + 1 == Math.min(iLevel, aManaCosts.length)) {
        _sValue = "<span class='GameplayVariable'>" + _sValue + "</span>";
        fCurrentManaCost = _value;
      }

      sManaCostDescription = sManaCostDescription + _sValue;
    }
  }
  ...
  toggleClass['UsesAbilityCharges'] = false; // 物品等级，用中立物品的样式来显示

  var iNeutralTier = GetItemRarity(abilityname);
  ...
  if (bIsItem && iAbilityIndex != -1) {
    if (sCastType == "DOTA_ToolTip_Ability_Toggle") {
      ...
      var iCurrentCharges = Items.GetCurrentCharges(iAbilityIndex);
  ...
  var update = function update() {
    ...
    if (pSelf) {
      var _iAbilityIndex = -1;

      if (entityindex != -1 && inventoryslot != -1) {
        _iAbilityIndex = Entities.GetItemInSlot(entityindex, inventoryslot);
      } else if (entityindex != -1) {
        _iAbilityIndex = Entities.GetAbilityByName(entityindex, abilityname);
      }

      if (pSelf.BHasClass("ShowSellPriceTime")) {
        var _iItemCost = _iAbilityIndex != -1 ? Items.GetCost(_iAbilityIndex) : GetItemCost(abilityname);

        var _fPurchaseTime = Items.GetPurchaseTime(_iAbilityIndex);

        var _bOriginalPrice = Game.GetGameTime() <= _fPurchaseTime + 10;

        pSelf.SetDialogVariableInt("sell_price", _bOriginalPrice ? _iItemCost : _iItemCost / 2);
        pSelf.SetHasClass("ShowSellPriceTime", _bOriginalPrice);
        pSelf.SetHasClass("ShowSellPrice", !_bOriginalPrice);

        var _fTime = Game.GetGameTime() - _fPurchaseTime;

        var _sStr = "";

        if (_fTime <= 10) {
          _fTime = parseInt((10 - _fTime).toFixed(0));

          var _sMinute = Math.floor(_fTime / 60).toString();

          var _sSecond = (_fTime % 60).toString();

          if (_sSecond.length == 1) _sSecond = "0" + _sSecond;
          _sStr = _sMinute + ":" + _sSecond;
        }

        pSelf.SetDialogVariable("sell_time", _sStr);
      }

      if (pSelf.BHasClass("ShowItemCost")) {
        var _iItemCost2 = _iAbilityIndex != -1 ? Items.GetCost(_iAbilityIndex) : GetItemCost(abilityname);

        pSelf.SetDialogVariableInt('buy_cost', _iItemCost2);

        var _iGold = Players.GetGold(Players.GetLocalPlayer());

        pSelf.SetHasClass("NotEnoughGold", _iGold < _iItemCost2);
        pSelf.SetDialogVariableInt('buy_cost_deficit', _iItemCost2 - _iGold);
      }
    }
  };
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    if (iAbilityIndex != -1) {
      listener = GameEvents.Subscribe("dota_ability_changed", function (tEvents) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, _extends({
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("AbilityDetails", toggleClass)
  }, other, {
    ref: refSelf,
    ...
    id: "AbilityName",
    className: "TitleFont",
    text: $.Localize("DOTA_Tooltip_ability_" + abilityname),
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityLevel",
    ...
    localizedText: "#DOTA_AbilityTooltip_Level",
    html: true
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilitySubHeader"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "ItemSubtitle",
    localizedText: "{s:item_subtitle}"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "ItemAvailibilityMainShop",
    className: "ItemAvailabilityRow"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "ItemAvailabilityIcon MainShopIcon"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "ItemAvailibilitySideShop",
    className: "ItemAvailabilityRow"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "ItemAvailabilityIcon SideShopIcon"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "ItemAvailibilitySecretShop",
    className: "ItemAvailabilityRow"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "ItemAvailabilityIcon SecretShopIcon"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "TopBottomFlow"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "NeutralItemTier",
    html: true,
    localizedText: "#DOTA_NeutralItemTier"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "LeftRightFlow"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "ItemCost"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "ItemCostIcon"
    ...
    id: "BuyCostLabel",
    localizedText: "{d:r:buy_cost}"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "BuyCostDeficit",
    localizedText: "(-{d:r:buy_cost_deficit})"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "StockContainer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "RestockTime",
    localizedText: "#DOTA_HUD_Shop_Restock"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "StockAmount",
    localizedText: "#DOTA_HUD_Shop_StockAmount"
  }))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "CostToComplete",
    localizedText: "#DOTA_HUD_Shop_Item_Complete"
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilityTarget"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilityTopRowContainer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityCastType",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sCastType == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_CastType",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "CurrentAbilityCosts",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': bIsItem || fCurrentCooldown == 0 && fCurrentManaCost == 0
    })
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "CurrentAbilityManaCost",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("ManaCost", {
      'Hidden': bIsItem || fCurrentManaCost == 0
    }),
    localizedText: "{s:current_manacost}",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "CurrentAbilityCooldown",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("Cooldown", {
      'Hidden': bIsItem || fCurrentCooldown == 0
    }),
    localizedText: "{s:current_cooldown}",
    html: true
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityTargetType",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sTargetType == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_TargetType",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityDamageType",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sDamageType == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_DamageType",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilitySpellImmunityType",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sSpellImmunity == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_SpellImmunityType",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityDispelType",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sDispelType == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_DispelType",
    html: true
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilityCoreDetails"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityAttributes",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sAttributes == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_Attributes",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilityDescriptionOuterContainer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "CurrentItemCosts",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': !bIsItem
    ...
    var sAllDescription = "DOTA_Tooltip_ability_" + abilityname + "_Description";
    var list = [];

    if ($.Localize(sAllDescription) != sAllDescription) {
      var aDescriptions = $.Localize(sAllDescription).split("\n");
      var iOriginalDescriptions = aDescriptions.length;

      if (entityindex != -1) {
        var t = CustomNetTables.GetTableValue("ability_upgrades_list", entityindex.toString());
        ...
        if (t && typeof t.json == "string") {
          ...
          if (aAbilityUpgradesList) {
            for (var index = 1; index < aAbilityUpgradesList.length; index++) {
              var aData = aAbilityUpgradesList[index];

              var _tData = upzip(aAbilityUpgradesList[0], aData);

              if (_tData.type - 1 == CustomUIConfig.ABILITY_UPGRADES_TYPE_ABILITY_MECHANICS && _tData.ability_name == abilityname) {
                aDescriptions.push($.Localize("dota_tooltip_ability_mechanics_" + _tData.ability_name + "_" + _tData.description));
              }
            }
          }
        }
      ...
      for (var _i5 = 0; _i5 < aDescriptions.length; _i5++) {
        var sUnprocessedDescription = aDescriptions[_i5];
        var sDescription = sUnprocessedDescription;
        if (sDescription == "") continue;
        var regexp = new RegExp("<h1>.+?</h1>", "");
        var aHeaders = sDescription.match(regexp);

        if (aHeaders) {
          var _iterator2 = _createForOfIteratorHelper(aHeaders),
              _step2;

          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var sHeader = _step2.value;
              ++iLine;
              list.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
                key: list.length.toString(),
                className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('Header', {
                  'Active': bIsActive && iLine == iActiveDescriptionLine
                }),
                text: sHeader,
                html: true
              }));
        ...
        sDescription = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.replaceValues)(sDescription, showextradescription, abilityname, iLevel, entityindex, true);
        list.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
          key: list.length.toString(),
          className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
            'Active': bIsActive && iLine == iActiveDescriptionLine,
            'AbilityMechanics': _i5 >= iOriginalDescriptions
          }),
          text: sDescription,
          html: true
        }));
    ...
    id: "AbilityScepterDescriptionContainer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "ScepterUpgradeHeader"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "ScepterSpecialAbilityDataIcon"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    className: "ScepterUpgradeHeaderLabel",
    localizedText: "#DOTA_AbilityTooltip_ScepterUpgrade_Header"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    className: "ScepterUpgradeBodyLabel",
    localizedText: "{s:scepter_upgrade_description}",
    html: true
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilityDraftDescriptionContainer"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "AbilityDraftUpgradeHeader"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    className: "AbilityDraftIcon"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    className: "AbilityDraftHeaderLabel",
    localizedText: "#DOTA_AbilityTooltip_AbilityDraftNote_Header"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    className: "ScepterUpgradeBodyLabel",
    localizedText: "{s:ability_draft_note}",
    html: true
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityExtraDescription",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sExtraDescription == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_ExtraDescription",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "ItemScepterDescription",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': true
    }),
    localizedText: "{s:itemscepterdescription}",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityCharges",
    localizedText: "#DOTA_AbilityTooltip_AbilityCharges",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityExtraAttributes",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': sExtraAttributes == ""
    }),
    localizedText: "{s:extra_attributes}",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilityCosts"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityCooldown",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("Cooldown", {
      'Hidden': sCooldownDescription == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_Cooldown",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityManaCost",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("ManaCost", {
      'Hidden': sManaCostDescription == ""
    }),
    localizedText: "#DOTA_AbilityTooltip_ManaCost",
    html: true
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, {
    id: "AbilityGameplayChanges"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityLore",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': $.Localize(sLore) == sLore
    }),
    localizedText: "#DOTA_AbilityTooltip_Lore",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "AbilityUpgradeLevel",
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
      'Hidden': iAbilityLearnResult != AbilityLearnResult_t.ABILITY_CANNOT_BE_UPGRADED_REQUIRES_LEVEL
    }),
    localizedText: "#DOTA_AbilityTooltip_UpgradeLevel",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "OwnedBy",
    localizedText: "#DOTA_HUD_Item_Owned_By",
    html: true
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "SellPriceLabel",
    localizedText: "#DOTA_HUD_Item_Tooltip_Sell_Price"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "SellPriceTimeLabel",
    localizedText: "#DOTA_HUD_Item_Tooltip_Sell_Price_Time"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "DisassembleLabel",
    localizedText: "#DOTA_HUD_Item_Tooltip_Disassemble"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "DisassembleTimeLabel",
    localizedText: "#DOTA_HUD_Item_Tooltip_Disassemble_Time"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "NotEnoughGoldLabel",
    localizedText: "#DOTA_Shop_Item_Error_Cant_Afford"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, {
    id: "ConsumableAbilityInfo",
    localizedText: "#DOTA_HUD_Item_Tooltip_Consumable_Info"
  }));
}
...
/***/ "./tooltips/tooltip_ability/script.jsx":
/*!*********************************************!*\
  !*** ./tooltips/tooltip_ability/script.jsx ***!
  \*********************************************/
/*! namespace exports */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _elements_AbilityDetails_AbilityDetails__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../elements/AbilityDetails/AbilityDetails */ "./elements/AbilityDetails/AbilityDetails.jsx");
...
var m_iAbilityIndex = -1;
var m_sAbilityName = "";
var m_iEntityIndex = -1;
var m_iInventorySlot = -1;
var m_iLevel = -1;
var m_iCastRangeParticleID = -1;
var m_bToggleState = false;
...
function SetupTooltip() {
  ...
  if (m_iEntityIndex != -1 && m_iInventorySlot != -1) {
    ...
    if (m_iAbilityIndex && m_iAbilityIndex != -1) m_sAbilityName = Abilities.GetAbilityName(m_iAbilityIndex);
  } else if (m_iEntityIndex != -1) {
    m_iAbilityIndex = Entities.GetAbilityByName(m_iEntityIndex, m_sAbilityName);
  }

  var tAbility = CustomUIConfig.AbilitiesKv[m_sAbilityName];
  var tItem = CustomUIConfig.ItemsKv[m_sAbilityName];
  var tData = tAbility || tItem;
  var bIsItem = tData == tItem;
  pSelf.SetHasClass("IsItem", bIsItem);
  (0,react_panorama__WEBPACK_IMPORTED_MODULE_2__.render)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_elements_AbilityDetails_AbilityDetails__WEBPACK_IMPORTED_MODULE_0__.AbilityDetails, {
    id: "AbilityDetails",
    abilityname: m_sAbilityName,
    entityindex: m_iEntityIndex,
    inventoryslot: m_iInventorySlot,
    level: m_iLevel,
    showextradescription: pSelf.BHasClass("ShowExtraDescription")
  }), pSelf);

  if (m_iAbilityIndex != -1) {
    m_bToggleState = Abilities.GetToggleState(m_iAbilityIndex);
    var fCastRange = Abilities.GetCastRange(m_iAbilityIndex);
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./tooltips/tooltip_ability/script.jsx");
