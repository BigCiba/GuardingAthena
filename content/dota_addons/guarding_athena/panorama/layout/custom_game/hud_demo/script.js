...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "../../../../../node_modules/react/index.js");
;
function Compile({ onload }) {
    let init = (element) => {
        if (element != null) {
            element.BLoadLayout("file://{resources}/layout/custom_game/compile.xml", false, false);
        }
    };
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "Compile", ref: init, onload: onload }));
}
...
/* harmony import */ var _compile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./compile */ "./hud_demo/compile.tsx");
...
function Root(_a) {
    var other = __rest(_a, []);
    const [itemsNames, setItemNames] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(() => {
        let items = [];
    ...
    // 	return items;
    // });
    const [heroNames, setHeroNames] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(() => {
        let items = [];
        for (const heroName in GameUI.CustomUIConfig().HeroesKv) {
            ...
            if (typeof (heroData) != "object")
                continue;
            if (heroData.override_hero == undefined)
                continue;
            if (heroName == "Version")
                continue;
            items.push(heroName);
    ...
    // 	return false;
    // };
    const [compile, setCompile] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.useRefreshEvent)("RefreshContainer");
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, Object.assign({ className: "CustomHudRoot" }, other, { style: { visibility:  true ? "visible" : 0 } }),
        ...
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "DemoPanel", className: "ControlPanel TopBottomFlow" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "ControlPanelContainer" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "Maximized" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "MinimizeButton" },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: "#DemoOptions_MinimizeButton" })),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "CategoryContainer" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Category" },
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(SelectionButton, { eventName: "AddPassiveAbility", text: "\u6DFB\u52A0\u989D\u5916\u6280\u80FD" }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "RemoveAllPassiveAbility", text: "\u79FB\u9664\u6240\u6709\u989D\u5916\u6280\u80FD" }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(SelectionButton, { eventName: "AddItem", text: "\u6DFB\u52A0\u7269\u54C1" }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "RemoveInventoryItemsButtonPressed", text: "\u79FB\u9664\u6240\u6709\u7269\u54C1" }))),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "CategoryContainer" },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: "#Hero_ButtonCategory" }),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Category" },
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "RefreshButtonPressed", text: "\u5237\u65B0\u72B6\u6001" }),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "CategoryContainer" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Category" },
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(SelectionButton, { eventName: "SwitchHero", text: "\u5207\u6362\u82F1\u96C4" }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "DummyTargetButtonPressed", text: "\u5080\u5121\u76EE\u6807" }),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "CategoryContainer" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Category" },
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "", text: "#Compile_Button", onactivate: () => { setCompile(true); } }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "SetWinnerPressed", text: "#SetWinner_Button" }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "RestartButtonPressed", text: "\u91CD\u5F00\u6E38\u620F" }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(CommonButton, { eventName: "ReloadScriptButtonPressed", text: "#ReloadScript_Button" }),
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(TextEntryButton, { eventName: "DrawCircle", text: "\u753B\u5708" }))))),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { id: "ControlPanelSlideThumb", onactivate: () => {
                    pSelf.ToggleClass('Minimized');
                    bManualShowDemo = pSelf.BHasClass("Minimized");
                } },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "BottomArrowButtonIcon", text: "ALT" }))),
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "Compile" }, compile && react__WEBPACK_IMPORTED_MODULE_1__.createElement(_compile__WEBPACK_IMPORTED_MODULE_4__.Compile, { onload: () => { setCompile(false); } }))));
}
// 普通按钮
function CommonButton({ eventName, str = "", text, onactivate = () => FireEvent(eventName, str) }) {
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Row" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "DemoButton", onactivate: onactivate },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: text }))));
}
// 切换按钮
function CommonToggleButton({ eventName, str = "", setting, text }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Row" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(ToggleButton, { id: "ToggleFogButton", className: "DemoButton", selected: selected, onactivate: () => { FireEvent(eventName, str); setSelected(!selected); } },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: text }))));
}
// 下拉按钮
function DropDownButton({ eventName, list, width = "140px", text }) {
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Row" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "DemoButton", onactivate: (self) => {
                let drop = self.FindChildTraverse("DemoDropDown");
                let select = drop.GetSelected();
                FireEvent(eventName, select.text);
            } },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(DropDown, { id: "DemoDropDown", selected: list[0], oninputsubmit: (self) => {
                    let pSelected = self.GetSelected();
                    if (pSelected) {
                        FireEvent(eventName, pSelected.text);
                    }
                } }, list.map((tData, key) => {
                return react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { style: { width: width }, key: String(tData), id: String(tData), text: String(tData) });
            })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: text }))));
}
// 文本输入按钮
function TextEntryButton({ eventName, text, defaultValue = "" }) {
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Row" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "DemoButton", onactivate: (self) => {
                let TextEntry = self.FindChildTraverse("CommonTextEntry");
                FireEvent(eventName, TextEntry.text);
            } },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(TextEntry, { id: "CommonTextEntry", className: "DemoTextEntry", text: defaultValue, oninputsubmit: (self) => {
                    FireEvent(eventName, self.text);
                } }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: text }))));
}
// 选择按钮
function SelectionButton({ eventName, text }) {
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "Row" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "DemoButton", onactivate: () => {
                ToggleSelection(eventName);
                (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DispatchRefreshEvent)(eventName);
                (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DispatchRefreshEvent)("RefreshContainer");
            } },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Image, { className: "SelectionButtonIcon" }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: text }))));
}
var SelectionItemType;
(function (SelectionItemType) {
    SelectionItemType[SelectionItemType["SELECTION_ITEM_TYPE_COMMON"] = 0] = "SELECTION_ITEM_TYPE_COMMON";
    SelectionItemType[SelectionItemType["SELECTION_ITEM_TYPE_ABILITY"] = 1] = "SELECTION_ITEM_TYPE_ABILITY";
    SelectionItemType[SelectionItemType["SELECTION_ITEM_TYPE_ABILITY_UPGRADE"] = 2] = "SELECTION_ITEM_TYPE_ABILITY_UPGRADE";
    SelectionItemType[SelectionItemType["SELECTION_ITEM_TYPE_ITEM"] = 3] = "SELECTION_ITEM_TYPE_ITEM";
    SelectionItemType[SelectionItemType["SELECTION_ITEM_TYPE_HERO"] = 4] = "SELECTION_ITEM_TYPE_HERO";
    SelectionItemType[SelectionItemType["SELECTION_ITEM_TYPE_WEARABLE"] = 5] = "SELECTION_ITEM_TYPE_WEARABLE";
 ...
 */
function SelectContainer({ eventName, text, list, toggleList = {}, filter, type = SelectionItemType.SELECTION_ITEM_TYPE_COMMON }) {
    const [filterWord, setFilterWord] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const [selectedFilter, setSelectedFilter] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({});
    const onactivate = (self, key) => {
        if (self.IsSelected() == true) {
            setSelectedFilter(Object.assign(Object.assign({}, selectedFilter), { [key]: toggleList[key] }));
        }
        else {
    ...
    const [size, setSize] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("NormalSize");
    const [lock, toggleLock] = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.useToggle)(false);
    const [textMode, toggleTextMode] = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.useToggle)(true);
    const ToggleSize = (self) => {
        if (size == "NormalSize") {
            setSize("ThinSize");
        }
        if (size == "ThinSize") {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: eventName, className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("SelectionContainer", { LockWindow: lock }), hittest: true },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "SelectionPicker", className: size },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "SelectionPickerHeader", onmouseover: DragStart, onmouseout: () => GameUI.CustomUIConfig().EndDrag() },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "CloseButton", onactivate: () => ToggleSelection(eventName) }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "SelectionChoice", localizedText: text }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "FillWidth" }),
                Object.keys(toggleList).map((key) => {
                    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(ToggleButton, { key: key, text: key, onactivate: (self) => onactivate(self, key) });
                }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "SelectionSearch", className: "SearchBox" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(TextEntry, { id: "SelectionSearchTextEntry", placeholder: "#DOTA_Search", oninputsubmit: (self) => setFilterWord(self.text), ontextentrychange: (self) => {
                            if (self.text == "" && filterWord != "") {
                                setFilterWord("");
                            }
                        } }),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { id: "SelectionSearchButton" })),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "RowMode", onactivate: toggleTextMode, onmouseover: (self) => (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DOTAShowTextTooltip)(self, "源码模式"), onmouseout: (self) => (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DOTAHideTextTooltip)(self) }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "Resize", onactivate: ToggleSize, onmouseover: (self) => (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DOTAShowTextTooltip)(self, "切换样式"), onmouseout: (self) => (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DOTAHideTextTooltip)(self) }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { className: "Lock", onactivate: ToggleLock, onmouseover: (self) => (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DOTAShowTextTooltip)(self, "锁定窗口"), onmouseout: (self) => (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.DOTAHideTextTooltip)(self) })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "SelectionList" }, list.map((itemName) => {
                ...
                if ((filterWord == "" || localize.search(filterWord) != -1) && (filter ? filter(itemName, selectedFilter) : true)) {
                    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(SelectContainerItem, { key: itemName, eventName: eventName, itemName: itemName, type: type, textMode: textMode });
                }
            })))));
}
function SelectContainerItem({ eventName, itemName, type, textMode }) {
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null,
        ...
        type == SelectionItemType.SELECTION_ITEM_TYPE_ABILITY &&
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "AbilityPickerCard", onactivate: () => FireEvent(eventName, itemName) },
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "AbilityPickerCardName", text: textMode ? $.Localize("DOTA_Tooltip_ability_" + itemName) : itemName })),
        type == SelectionItemType.SELECTION_ITEM_TYPE_ITEM &&
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "ItemPickerCard", onactivate: () => FireEvent(eventName, itemName) },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(DOTAItemImage, { id: "ItemPickerCardImage", itemname: itemName, showtooltip: true }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "ItemPickerCardName", text: textMode ? $.Localize("DOTA_Tooltip_ability_" + itemName) : itemName })),
        type == SelectionItemType.SELECTION_ITEM_TYPE_WEARABLE &&
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "WearablePickerCard", onmouseover: (self) => $.DispatchEvent("DOTAShowEconItemTooltip", self, itemName, -1, -1), onmouseout: (self) => $.DispatchEvent("DOTAHideEconItemTooltip", self), onactivate: () => FireEvent(eventName, itemName) },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "EconItemImage", itemdef: itemName, key: itemName, id: "EconItemIcon", scaling: "stretch-to-cover-preserve-aspect" }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "ItemPickerCardName", text: textMode ? $.Localize("DOTA_Tooltip_ability_item_wearable_" + itemName) : itemName })),
        type == SelectionItemType.SELECTION_ITEM_TYPE_HERO &&
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "HeroPickerCard", onactivate: () => FireEvent(eventName, itemName) },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(DOTAHeroImage, { heroimagestyle: "portrait", heroname: itemName, id: "HeroPickerCardImage", scaling: "stretch-to-fit-x-preserve-aspect" }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "ItemPickerCardName", text: textMode ? $.Localize(itemName) : itemName }))));
}
(0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_2__.render)(react__WEBPACK_IMPORTED_MODULE_1__.createElement(Root, { hittest: false }), pSelf);
...
/*!************************!*\
  ...
  \************************/
/*! namespace exports */
/*! export DOTAHideTextTooltip [provided] [no usage info] [missing usage info prevents renaming] */
/*! export DOTAShowTextTooltip [provided] [no usage info] [missing usage info prevents renaming] */
/*! export DispatchRefreshEvent [provided] [no usage info] [missing usage info prevents renaming] */
...
/*! export HideContextMenu [provided] [no usage info] [missing usage info prevents renaming] */
/*! export HideCustomTooltip [provided] [no usage info] [missing usage info prevents renaming] */
/*! export HideTextTooltip [provided] [no usage info] [missing usage info prevents renaming] */
/*! export LogHelper [provided] [no usage info] [missing usage info prevents renaming] */
...
/*! export ShowContextMenu [provided] [no usage info] [missing usage info prevents renaming] */
/*! export ShowCustomTooltip [provided] [no usage info] [missing usage info prevents renaming] */
...
/*! export useHeartBeat [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useNetTable [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useNetTableJson [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useNetTableState [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useRefresh [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useRefreshEvent [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useRefreshState [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useSchedule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useToggle [provided] [no usage info] [missing usage info prevents renaming] */
/*! export useToogleWindow [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__, __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "useToogleWindow": () => /* binding */ useToogleWindow,
/* harmony export */   "useRefresh": () => /* binding */ useRefresh,
/* harmony export */   "useNetTable": () => /* binding */ useNetTable,
/* harmony export */   "useNetTableJson": () => /* binding */ useNetTableJson,
...
function useToogleWindow(window_name) {
    const [state, toggleState, setState] = useToggle(false);
    (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_1__.useGameEvent)("custom_ui_toggle_windows", data => {
...
function useRefresh(deps) {
    const [refresh, setRefresh] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("-1");
...
function useNetTableJson(name, key) {
    const [value, setValue] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(() => Transform(CustomNetTables.GetTableValue(name, key), name));
...
function useHeartBeat(iInterval) {
    const [fTime, SetTime] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(Game.Time());
    useSchedule(() => {
        SetTime(Game.Time());
        return iInterval;
    }, []);
...
function useRefreshEvent(eventName) {
    const [fTime, SetTime] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(Game.Time());
    (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_1__.useGameEvent)("custom_refresh_order", (event) => {
...
function useNetTableState(name, key, initialState, callback) {
    ...
    const nettable = (0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_1__.useNetTableKey)(name, key);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        callback(nettable);
    }, [nettable]);
...
(function (LogHelper) {
    ...
    LogHelper.warn = warn;
    function DeepPrintTable(table) {
        if (!LogHelper.IsDebug) {
            return;
        }
    }
    LogHelper.DeepPrintTable = DeepPrintTable;
})(LogHelper || (LogHelper = {}));
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./hud_demo/script.tsx");
