 ...
 */function useNetTableValues(name) { var _useState3 = (0, react__WEBPACK_IMPORTED_MODULE_0__.useState)(function () { return CustomNetTables.GetAllTableValues(name).reduce(function (accumulator, pair) { return Object.assign(Object.assign({}, accumulator), _defineProperty({}, pair.key, pair.value)); }, {}); }), _useState4 = _slicedToArray(_useState3, 2), values = _useState4[0], setValue = _useState4[1]; (0, react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () { var listener = CustomNetTables.SubscribeNetTableListener(name, function (_, eventKey, eventValue) { setValue(function (current) { return Object.assign(Object.assign({}, current), _defineProperty({}, eventKey, eventValue)); }); }); return function () { return CustomNetTables.UnsubscribeNetTableListener(listener); }; }, [name]); return values; } var _a; var noop = function noop() { }; var microtaskPromise = Promise.resolve(); function queueMicrotask(callback) {// eslint-disable-next-line @typescript-eslint/no-floating-promises, promise/catch-or-return, promise/prefer-await-to-then, promise/no-callback-in-promise
        ...
        } var reactPanoramaSymbol = Symbol('_reactPanoramaSymbol');// TODO: Put it into a shared library?
...
(c) Sindre Sorhus
@license MIT
*/ /* eslint-disable no-unused-vars */var getOwnPropertySymbols = Object.getOwnPropertySymbols; var hasOwnProperty = Object.prototype.hasOwnProperty; var propIsEnumerable = Object.prototype.propertyIsEnumerable; function toObject(val) { if (val === null || val === undefined) { throw new TypeError('Object.assign cannot be called with null or undefined'); } return Object(val); } function shouldUseNative() {
          try {
            if (!Object.assign) { return false; }// Detect buggy property enumeration order in older V8 versions.
            // https://bugs.chromium.org/p/v8/issues/detail?id=4118
            var test1 = new String('abc');// eslint-disable-line no-new-wrappers
            test1[5] = 'de'; if (Object.getOwnPropertyNames(test1)[0] === '5') { return false; }// https://bugs.chromium.org/p/v8/issues/detail?id=3056
            var test2 = {}; for (var i = 0; i < 10; i++) { test2['_' + String.fromCharCode(i)] = i; } var order2 = Object.getOwnPropertyNames(test2).map(function (n) { return test2[n]; }); if (order2.join('') !== '0123456789') { return false; }// https://bugs.chromium.org/p/v8/issues/detail?id=3056
            var test3 = {}; 'abcdefghijklmnopqrst'.split('').forEach(function (letter) { test3[letter] = letter; }); if (Object.keys(Object.assign({}, test3)).join('') !== 'abcdefghijklmnopqrst') { return false; } return true;
          } catch (err) {// We don't expect any of the above to throw, but better to be safe.
            return false;
          }
        } var D__dev_dota__modules_reactPanorama_node_modules_objectAssign = shouldUseNative() ? Object.assign : function (target, source) { var from; var to = toObject(target); var symbols; for (var s = 1; s < arguments.length; s++) { from = Object(arguments[s]); for (var key in from) { if (hasOwnProperty.call(from, key)) { to[key] = from[key]; } } if (getOwnPropertySymbols) { symbols = getOwnPropertySymbols(from); for (var i = 0; i < symbols.length; i++) { if (propIsEnumerable.call(from, symbols[i])) { to[symbols[i]] = from[symbols[i]]; } } } } return to; };/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ReactPropTypesSecret = 'SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED'; var ReactPropTypesSecret_1 = ReactPropTypesSecret; var printWarning = function printWarning() { }; {
          var ReactPropTypesSecret$1 = ReactPropTypesSecret_1; var loggedTypeFailures = {}; var has = Function.call.bind(Object.prototype.hasOwnProperty); printWarning = function printWarning(text) {
            var message = 'Warning: ' + text; if (typeof console !== 'undefined') { console.error(message); } try {// --- Welcome to debugging React ---
              // This error was thrown as a convenience so that you can use this stack
              // to find the callsite that caused this warning to fire.
              throw new Error(message);
            } catch (x) { }
 ...
 *
 * @private
 */checkPropTypes.resetWarningCache = function () { { loggedTypeFailures = {}; } }; var checkPropTypes_1 = checkPropTypes; var scheduler_development = createCommonjsModule(function (module, exports) {
          {
            (function () {
              var enableSchedulerDebugging = false; var enableProfiling = true; var _requestHostCallback; var requestHostTimeout; var cancelHostTimeout; var shouldYieldToHost; var requestPaint; if (// If Scheduler runs in a non-DOM environment, it falls back to a naive
                ...
                var _callback = null; var _timeoutID = null; var _flushCallback = function _flushCallback() { if (_callback !== null) { try { var currentTime = exports.unstable_now(); var hasRemainingTime = true; _callback(hasRemainingTime, currentTime); _callback = null; } catch (e) { setTimeout(_flushCallback, 0); throw e; } } }; var initialTime = Date.now(); exports.unstable_now = function () { return Date.now() - initialTime; }; _requestHostCallback = function requestHostCallback(cb) {
                  ...
                  } else { _callback = cb; setTimeout(_flushCallback, 0); }
                }; requestHostTimeout = function requestHostTimeout(cb, ms) { _timeoutID = setTimeout(cb, ms); }; cancelHostTimeout = function cancelHostTimeout() { clearTimeout(_timeoutID); }; shouldYieldToHost = function shouldYieldToHost() { return false; }; requestPaint = exports.unstable_forceFrameRate = function () { };
              } else {// Capture local references to native APIs, in case a polyfill overrides them.
                ...
                {// `isInputPending` is not available. Since we have no way of knowing if
                  ...
                  if (fps < 0 || fps > 125) {// Using console['error'] to evade Babel and ESLint
                    console['error']('forceFrameRate takes a positive int between 0 and 125, ' + 'forcing framerates higher than 125 fps is not unsupported'); return;
                  } if (fps > 0) { yieldInterval = Math.floor(1000 / fps); } else {// reset the framerate
                    yieldInterval = 5;
                  }
                  ...
                  if (scheduledHostCallback !== null) {
                    ...
                    // the message event.
                    deadline = currentTime + yieldInterval; var hasTimeRemaining = true; try {
                      var hasMoreWork = scheduledHostCallback(hasTimeRemaining, currentTime); if (!hasMoreWork) { isMessageLoopRunning = false; scheduledHostCallback = null; } else {// If there's more work, schedule the next message event at the end
                        // of the preceding one.
                        port.postMessage(null);
                      }
                    } catch (error) {// If a scheduler task throws, exit the current browser task so the
                      // error can be observed.
                      port.postMessage(null); throw error;
                    }
                  } else { isMessageLoopRunning = false; }// Yielding to the browser will give it a chance to paint, so we can
                }; var channel = new MessageChannel(); var port = channel.port2; channel.port1.onmessage = performWorkUntilDeadline; _requestHostCallback = function _requestHostCallback(callback) { scheduledHostCallback = callback; if (!isMessageLoopRunning) { isMessageLoopRunning = true; port.postMessage(null); } }; requestHostTimeout = function requestHostTimeout(callback, ms) { taskTimeoutID = _setTimeout(function () { callback(exports.unstable_now()); }, ms); }; cancelHostTimeout = function cancelHostTimeout() { _clearTimeout(taskTimeoutID); taskTimeoutID = -1; };
              } function push(heap, node) { var index = heap.length; heap.push(node); siftUp(heap, node, index); } function peek(heap) { var first = heap[0]; return first === undefined ? null : first; } function pop(heap) { var first = heap[0]; if (first !== undefined) { var last = heap.pop(); if (last !== first) { heap[0] = last; siftDown(heap, last, 0); } return first; } else { return null; } } function siftUp(heap, node, i) {
                var index = i; while (true) {
                  var parentIndex = index - 1 >>> 1; var parent = heap[parentIndex]; if (parent !== undefined && compare(parent, node) > 0) {// The parent is larger. Swap positions.
                ...
                var index = i; var length = heap.length; while (index < length) {
                  var leftIndex = (index + 1) * 2 - 1; var left = heap[leftIndex]; var rightIndex = leftIndex + 1; var right = heap[rightIndex];// If the left or right node is smaller, swap with the smaller of those.
              ...
              } function compare(a, b) {// Compare sort index first, then task id.
                var diff = a.sortIndex - b.sortIndex; return diff !== 0 ? diff : a.id - b.id;
              }// TODO: Use symbols?
              ...
              var PRIORITY = 0; var CURRENT_TASK_ID = 1; var CURRENT_RUN_ID = 2; var QUEUE_SIZE = 3; {
                profilingState[PRIORITY] = NoPriority;// This is maintained with a counter, because the size of the priority queue
                // array might include canceled tasks.
                profilingState[QUEUE_SIZE] = 0; profilingState[CURRENT_TASK_ID] = 0;
              }// Bytes per element is 4
              var INITIAL_EVENT_LOG_SIZE = 131072; var MAX_EVENT_LOG_SIZE = 524288;// Equivalent to 2 megabytes
              var eventLogSize = 0; var eventLogBuffer = null; var eventLog = null; var eventLogIndex = 0; var TaskStartEvent = 1; var TaskCompleteEvent = 2; var TaskErrorEvent = 3; var TaskCancelEvent = 4; var TaskRunEvent = 5; var TaskYieldEvent = 6; var SchedulerSuspendEvent = 7; var SchedulerResumeEvent = 8; function logEvent(entries) {
                if (eventLog !== null) {
                  var offset = eventLogIndex; eventLogIndex += entries.length; if (eventLogIndex + 1 > eventLogSize) {
                    eventLogSize *= 2; if (eventLogSize > MAX_EVENT_LOG_SIZE) {// Using console['error'] to evade Babel and ESLint
                      console['error']("Scheduler Profiling: Event log exceeded maximum size. Don't " + 'forget to call `stopLoggingProfilingEvents()`.'); stopLoggingProfilingEvents(); return;
              ...
              var isPerformingWork = false; var isHostCallbackScheduled = false; var isHostTimeoutScheduled = false; function advanceTimers(currentTime) {// Check for tasks that are no longer delayed and add them to the queue.
                var timer = peek(timerQueue); while (timer !== null) {
                  if (timer.callback === null) {// Timer was cancelled.
                    pop(timerQueue);
                  } else if (timer.startTime <= currentTime) {// Timer fired. Transfer to the task queue.
                    pop(timerQueue); timer.sortIndex = timer.expirationTime; push(taskQueue, timer); { markTaskStart(timer, currentTime); timer.isQueued = true; }
                  } else {// Remaining timers are pending.
                    return;
                  } timer = peek(timerQueue);
                }
              } function handleTimeout(currentTime) { isHostTimeoutScheduled = false; advanceTimers(currentTime); if (!isHostCallbackScheduled) { if (peek(taskQueue) !== null) { isHostCallbackScheduled = true; _requestHostCallback(flushWork); } else { var firstTimer = peek(timerQueue); if (firstTimer !== null) { requestHostTimeout(handleTimeout, firstTimer.startTime - currentTime); } } } } function flushWork(hasTimeRemaining, initialTime) {
                { markSchedulerUnsuspended(initialTime); }// We'll need a host callback the next time work is scheduled.
                isHostCallbackScheduled = false; if (isHostTimeoutScheduled) {// We scheduled a timeout but it's no longer needed. Cancel it.
                  isHostTimeoutScheduled = false; cancelHostTimeout();
                } isPerformingWork = true; var previousPriorityLevel = currentPriorityLevel; try { if (enableProfiling) { try { return workLoop(hasTimeRemaining, initialTime); } catch (error) { if (currentTask !== null) { var currentTime = exports.unstable_now(); markTaskErrored(currentTask, currentTime); currentTask.isQueued = false; } throw error; } } } finally { currentTask = null; currentPriorityLevel = previousPriorityLevel; isPerformingWork = false; { var _currentTime = exports.unstable_now(); markSchedulerSuspended(_currentTime); } }
              } function workLoop(hasTimeRemaining, initialTime) {
                var currentTime = initialTime; advanceTimers(currentTime); currentTask = peek(taskQueue); while (currentTask !== null && !enableSchedulerDebugging) {
              ...
              } function unstable_runWithPriority(priorityLevel, eventHandler) { switch (priorityLevel) { case ImmediatePriority: case UserBlockingPriority: case NormalPriority: case LowPriority: case IdlePriority: break; default: priorityLevel = NormalPriority; }var previousPriorityLevel = currentPriorityLevel; currentPriorityLevel = priorityLevel; try { return eventHandler(); } finally { currentPriorityLevel = previousPriorityLevel; } } function unstable_next(eventHandler) {
                var priorityLevel; switch (currentPriorityLevel) {
                  case ImmediatePriority: case UserBlockingPriority: case NormalPriority:// Shift down to normal priority
                ...
                var parentPriorityLevel = currentPriorityLevel; return function () {// This is a fork of runWithPriority, inlined for performance.
                  var previousPriorityLevel = currentPriorityLevel; currentPriorityLevel = parentPriorityLevel; try { return callback.apply(this, arguments); } finally { currentPriorityLevel = previousPriorityLevel; }
                };
                ...
                var currentTime = exports.unstable_now(); var startTime; var timeout; if (_typeof(options) === 'object' && options !== null) { var delay = options.delay; if (typeof delay === 'number' && delay > 0) { startTime = currentTime + delay; } else { startTime = currentTime; } timeout = typeof options.timeout === 'number' ? options.timeout : timeoutForPriorityLevel(priorityLevel); } else { timeout = timeoutForPriorityLevel(priorityLevel); startTime = currentTime; } var expirationTime = startTime + timeout; var newTask = { id: taskIdCounter++, callback: callback, priorityLevel: priorityLevel, startTime: startTime, expirationTime: expirationTime, sortIndex: -1 }; { newTask.isQueued = false; } if (startTime > currentTime) {// This is a delayed task.
                  ...
                  newTask.sortIndex = expirationTime; push(taskQueue, newTask); { markTaskStart(newTask, currentTime); newTask.isQueued = true; }// Schedule a host callback, if needed. If we're already performing work,
                  // wait until the next time we yield.
                  if (!isHostCallbackScheduled && !isPerformingWork) { isHostCallbackScheduled = true; _requestHostCallback(flushWork); }
                } return newTask;
              } function unstable_pauseExecution() { } function unstable_continueExecution() { if (!isHostCallbackScheduled && !isPerformingWork) { isHostCallbackScheduled = true; _requestHostCallback(flushWork); } } function unstable_getFirstCallbackNode() { return peek(taskQueue); } function unstable_cancelCallback(task) {
                { if (task.isQueued) { var currentTime = exports.unstable_now(); markTaskCanceled(task, currentTime); task.isQueued = false; } }// Null out the callback to indicate the task has been canceled. (Can't
        ...
        }); var D__dev_dota__modules_reactPanorama_node_modules_scheduler = createCommonjsModule(function (module) { { module.exports = scheduler_development; } }); var schedulerTracing_development = createCommonjsModule(function (module, exports) {
          {
            (function () {
              ...
              exports.__subscriberRef = null; { exports.__interactionsRef = { current: new Set() }; exports.__subscriberRef = { current: null }; } function unstable_clear(callback) { var prevInteractions = exports.__interactionsRef.current; exports.__interactionsRef.current = new Set(); try { return callback(); } finally { exports.__interactionsRef.current = prevInteractions; } } function unstable_getCurrent() { { return exports.__interactionsRef.current; } } function unstable_getThreadID() { return ++threadIDCounter; } function unstable_trace(name, timestamp, callback) {
                var threadID = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : DEFAULT_THREAD_ID; var interaction = { __count: 1, id: interactionIDCounter++, name: name, timestamp: timestamp }; var prevInteractions = exports.__interactionsRef.current;// Traced interactions should stack/accumulate.
                // To do that, clone the current interactions.
                // The previous set will be restored upon completion.
                var interactions = new Set(prevInteractions); interactions.add(interaction); exports.__interactionsRef.current = interactions; var subscriber = exports.__subscriberRef.current; var returnValue; try { if (subscriber !== null) { subscriber.onInteractionTraced(interaction); } } finally {
                  try { if (subscriber !== null) { subscriber.onWorkStarted(interactions, threadID); } } finally {
                    try { returnValue = callback(); } finally {
                      exports.__interactionsRef.current = prevInteractions; try { if (subscriber !== null) { subscriber.onWorkStopped(interactions, threadID); } } finally {
 ...
 */function get(key) { return key._reactInternalFiber; } function set(key, value) { key._reactInternalFiber = value; }// The Symbol used to tag the ReactElement-like types. If there is no native Symbol
              ...
              var warnAboutStringRefs = false; var ReactCurrentOwner = ReactSharedInternals.ReactCurrentOwner; function getNearestMountedFiber(fiber) {
              ...
              } var BlockingRoot = 1; var ConcurrentRoot = 2; var Scheduler_runWithPriority = Scheduler.unstable_runWithPriority, Scheduler_scheduleCallback = Scheduler.unstable_scheduleCallback, Scheduler_cancelCallback = Scheduler.unstable_cancelCallback, Scheduler_shouldYield = Scheduler.unstable_shouldYield, Scheduler_requestPaint = Scheduler.unstable_requestPaint, Scheduler_now = Scheduler.unstable_now, Scheduler_getCurrentPriorityLevel = Scheduler.unstable_getCurrentPriorityLevel, Scheduler_ImmediatePriority = Scheduler.unstable_ImmediatePriority, Scheduler_UserBlockingPriority = Scheduler.unstable_UserBlockingPriority, Scheduler_NormalPriority = Scheduler.unstable_NormalPriority, Scheduler_LowPriority = Scheduler.unstable_LowPriority, Scheduler_IdlePriority = Scheduler.unstable_IdlePriority; {// Provide explicit error message when production+profiling bundle of e.g.
 ...
 */function shallowEqual(objA, objB) {
                ...
                for (var i = 0; i < keysA.length; i++) { if (!hasOwnProperty.call(objB, keysA[i]) || !objectIs(objA[keysA[i]], objB[keysA[i]])) { return false; } } return true;
   ...
   */function warnOnInvalidKey(child, knownKeys) { { if (_typeof(child) !== 'object' || child === null) { return knownKeys; } switch (child.$$typeof) { case REACT_ELEMENT_TYPE: case REACT_PORTAL_TYPE: warnForMissingKey(child); var key = child.key; if (typeof key !== 'string') { break; } if (knownKeys === null) { knownKeys = new Set(); knownKeys.add(key); break; } if (!knownKeys.has(key)) { knownKeys.add(key); break; } error('Encountered two children with the same key, `%s`. ' + 'Keys should be unique so that components maintain their identity ' + 'across updates. Non-unique keys may cause children to be ' + 'duplicated and/or omitted — the behavior is unsupported and ' + 'could change in a future version.', key); break; } } return knownKeys; } function reconcileChildrenArray(returnFiber, currentFirstChild, newChildren, expirationTime) {// This algorithm can't optimize by searching from both ends since we
              ...
              function resetChildFibers(workInProgress, renderExpirationTime) { var child = workInProgress.child; while (child !== null) { resetWorkInProgress(child, renderExpirationTime); child = child.sibling; } } var NO_CONTEXT = {}; var contextStackCursor$1 = createCursor(NO_CONTEXT); var contextFiberStackCursor = createCursor(NO_CONTEXT); var rootInstanceStackCursor = createCursor(NO_CONTEXT); function requiredContext(c) { if (!(c !== NO_CONTEXT)) { { throw Error("Expected host context to exist. This error is likely caused by a bug in React. Please file an issue."); } } return c; } function getRootHostContainer() { var rootInstance = requiredContext(rootInstanceStackCursor.current); return rootInstance; } function pushHostContainer(fiber, nextRootInstance) {// Push current root instance onto the stack;
                ...
                var rootInstance = requiredContext(rootInstanceStackCursor.current); var context = requiredContext(contextStackCursor$1.current); var nextContext = getChildHostContext(context, fiber.type, rootInstance);// Don't push this Fiber's context unless it's unique.
              ...
              var hydrationParentFiber = null; var nextHydratableInstance = null; var isHydrating = false; function enterHydrationState(fiber) { if (!supportsHydration) { return false; } var parentInstance = fiber.stateNode.containerInfo; nextHydratableInstance = getFirstHydratableChild(parentInstance); hydrationParentFiber = fiber; isHydrating = true; return true; } function deleteHydratableInstance(returnFiber, instance) {
                ...
                if (!supportsHydration) { { { throw Error("Expected prepareToHydrateHostInstance() to never be called. This error is likely caused by a bug in React. Please file an issue."); } } } var instance = fiber.stateNode; var updatePayload = hydrateInstance(instance, fiber.type, fiber.memoizedProps, rootContainerInstance, hostContext, fiber);// TODO: Type this specific to this type of component.
                fiber.updateQueue = updatePayload;// If the update payload indicates that there is a change or if there
                // is a new ref we mark this as an update.
                if (updatePayload !== null) { return true; } return false;
              } function prepareToHydrateHostTextInstance(fiber) {
                if (!supportsHydration) { { { throw Error("Expected prepareToHydrateHostTextInstance() to never be called. This error is likely caused by a bug in React. Please file an issue."); } } } var textInstance = fiber.stateNode; var textContent = fiber.memoizedProps; var shouldUpdate = hydrateTextInstance(textInstance, textContent, fiber); {
                ...
                if (!supportsHydration) { return false; } if (fiber !== hydrationParentFiber) {// We're deeper than the current hydration context, inside an inserted
                  // tree.
                  return false;
              ...
              } function markRef$1(workInProgress) { workInProgress.effectTag |= Ref; } var _appendAllChildren; var updateHostContainer; var updateHostComponent$1; var updateHostText$1; if (supportsMutation) {// Mutation mode
              ...
              } else if (supportsPersistence) {// Persistent host tree mode
                _appendAllChildren = function appendAllChildren(parent, workInProgress, needsVisibilityToggle, isHidden) {// We only have the top Fiber that was created but we need recurse down its
                  // children to find all the terminal nodes.
                  var node = workInProgress.child; while (node !== null) {// eslint-disable-next-line no-labels
                    if (node.tag === HostComponent) {
                      var instance = node.stateNode; if (needsVisibilityToggle && isHidden) {// This child is inside a timed out tree. Hide it.
                        var props = node.memoizedProps; var type = node.type; instance = cloneHiddenInstance(instance, type, props, node);
                      } appendInitialChild(parent, instance);
                    } else if (node.tag === HostText) {
                      var _instance = node.stateNode; if (needsVisibilityToggle && isHidden) {// This child is inside a timed out tree. Hide it.
                        var text = node.memoizedProps; _instance = cloneHiddenTextInstance(_instance, text, node);
                      } appendInitialChild(parent, _instance);
                    } else if (node.tag === HostPortal); else if (node.tag === SuspenseComponent) {
                      if ((node.effectTag & Update) !== NoEffect) {// Need to toggle the visibility of the primary children.
                      ...
                      } if (node.child !== null) {// Continue traversing like normal
                        node.child["return"] = node; node = node.child; continue;
                      }
                    } else if (node.child !== null) { node.child["return"] = node; node = node.child; continue; }// $FlowFixMe This is correct but Flow is confused by the labeled break.
                    node = node; if (node === workInProgress) { return; } while (node.sibling === null) { if (node["return"] === null || node["return"] === workInProgress) { return; } node = node["return"]; } node.sibling["return"] = node["return"]; node = node.sibling;
                  }
                ...
                var appendAllChildrenToContainer = function appendAllChildrenToContainer(containerChildSet, workInProgress, needsVisibilityToggle, isHidden) {// We only have the top Fiber that was created but we need recurse down its
                  ...
                  var node = workInProgress.child; while (node !== null) {// eslint-disable-next-line no-labels
                    if (node.tag === HostComponent) {
                      ...
                      var _instance3 = node.stateNode; if (needsVisibilityToggle && isHidden) {// This child is inside a timed out tree. Hide it.
                        var text = node.memoizedProps; _instance3 = cloneHiddenTextInstance(_instance3, text, node);
                  ...
                  var portalOrRoot = workInProgress.stateNode; var childrenUnchanged = workInProgress.firstEffect === null; if (childrenUnchanged); else {
                    var container = portalOrRoot.containerInfo; var newChildSet = createContainerChildSet(container);// If children might have changed, we have to add them all to the set.
                  ...
                  var currentInstance = current.stateNode; var oldProps = current.memoizedProps;// If there are no effects associated with this node, then none of our children had any updates.
                  ...
                  var childrenUnchanged = workInProgress.firstEffect === null; if (childrenUnchanged && oldProps === newProps) {// No changes, just reuse the existing instance.
                    ...
                    workInProgress.stateNode = currentInstance; return;
                  ...
                  case IndeterminateComponent: case LazyComponent: case SimpleMemoComponent: case FunctionComponent: case ForwardRef: case Fragment: case Mode: case Profiler: case ContextConsumer: case MemoComponent: return null; case ClassComponent: { var Component = workInProgress.type; if (isContextProvider(Component)) { popContext(workInProgress); } return null; } case HostRoot: {
                    ...
                    popHostContext(workInProgress); var rootContainerInstance = getRootHostContainer(); var type = workInProgress.type; if (current !== null && workInProgress.stateNode != null) { updateHostComponent$1(current, workInProgress, type, newProps, rootContainerInstance); if (current.ref !== workInProgress.ref) { markRef$1(workInProgress); } } else {
                      ...
                      var _wasHydrated = popHydrationState(workInProgress); if (_wasHydrated) {// TODO: Move this and createInstance step into the beginPhase
                        ...
                        var instance = createInstance(type, newProps, rootContainerInstance, currentHostContext, workInProgress); _appendAllChildren(instance, workInProgress, false, false);// This needs to be set before we mount Flare event listeners
              ...
              } var invokeGuardedCallbackImpl = function invokeGuardedCallbackImpl(name, func, context, a, b, c, d, e, f) { var funcArgs = Array.prototype.slice.call(arguments, 3); try { func.apply(context, funcArgs); } catch (error) { this.onError(error); } }; {// In DEV mode, we swap out invokeGuardedCallback for a special version
 ...
 */function invokeGuardedCallback(name, func, context, a, b, c, d, e, f) { hasError = false; caughtError = null; invokeGuardedCallbackImpl$1.apply(reporter, arguments); } function hasCaughtError() { return hasError; } function clearCaughtError() { if (hasError) { var error = caughtError; hasError = false; caughtError = null; return error; } else { { { throw Error("clearCaughtError was called but no error was captured. This error is likely caused by a bug in React. Please file an issue."); } } } } function logCapturedError(capturedError) {
              ...
              function safelyCallComponentWillUnmount(current, instance) { { invokeGuardedCallback(null, callComponentWillUnmountWithTimer, null, current, instance); if (hasCaughtError()) { var unmountError = clearCaughtError(); captureCommitPhaseError(current, unmountError); } } } function safelyDetachRef(current) { var ref = current.ref; if (ref !== null) { if (typeof ref === 'function') { { invokeGuardedCallback(null, ref, null, null); if (hasCaughtError()) { var refError = clearCaughtError(); captureCommitPhaseError(current, refError); } } } else { ref.current = null; } } } function safelyCallDestroy(current, destroy) { { invokeGuardedCallback(null, destroy, null); if (hasCaughtError()) { var error = clearCaughtError(); captureCommitPhaseError(current, error); } } } function commitBeforeMutationLifeCycles(current, finishedWork) {
                ...
                switch (finishedWork.tag) {
                  case FunctionComponent: case ForwardRef: case SimpleMemoComponent: case Block: {// At this point layout effects have already been destroyed (during mutation phase).
                    ...
                    if (current === null && finishedWork.effectTag & Update) { var type = finishedWork.type; var props = finishedWork.memoizedProps; commitMount(_instance2, type, props, finishedWork); } return;
                ...
                if (supportsMutation) {// We only have the top Fiber that was inserted but we need to recurse down its
                  // children to find all the terminal nodes.
              ...
              function commitUnmount(finishedRoot, current, renderPriorityLevel) {
                onCommitUnmount(current); switch (current.tag) {
                  case FunctionComponent: case ForwardRef: case MemoComponent: case SimpleMemoComponent: case Block: {
                    var updateQueue = current.updateQueue; if (updateQueue !== null) {
                      var lastEffect = updateQueue.lastEffect; if (lastEffect !== null) {
                        var firstEffect = lastEffect.next; {// When the owner fiber is deleted, the destroy function of a passive
                          ...
                          var priorityLevel = renderPriorityLevel > NormalPriority ? NormalPriority : renderPriorityLevel; runWithPriority(priorityLevel, function () { var effect = firstEffect; do { var _destroy = effect.destroy; if (_destroy !== undefined) { safelyCallDestroy(current, _destroy); } effect = effect.next; } while (effect !== firstEffect); });
                        }
                      }
                    } return;
                    ...
                    if (supportsMutation) { unmountHostComponents(finishedRoot, current, renderPriorityLevel); } else if (supportsPersistence) { emptyPortalContainer(current); } return;
                ...
                var node = root; while (true) {
                  ...
                  if (node.child !== null && (// If we use mutation we drill down into portals using commitUnmount above.
                    ...
                    !supportsMutation || node.tag !== HostPortal)) { node.child["return"] = node; node = node.child; continue; } if (node === root) { return; } while (node.sibling === null) { if (node["return"] === null || node["return"] === root) { return; } node = node["return"]; } node.sibling["return"] = node["return"]; node = node.sibling;
                }
                ...
                if (!supportsMutation) { return; }// Recursively insert all host nodes into the parent.
                ...
                if (!supportsMutation) {
                  switch (finishedWork.tag) {
                    ...
                    } case Profiler: { return; } case SuspenseComponent: { commitSuspenseComponent(finishedWork); attachSuspenseRetryListeners(finishedWork); return; } case SuspenseListComponent: { attachSuspenseRetryListeners(finishedWork); return; } case HostRoot: {
                      if (supportsHydration) {
                        var root = finishedWork.stateNode; if (root.hydrate) {// We've just hydrated. No need to hydrate again.
                          root.hydrate = false; commitHydratedContainer(root.containerInfo);
                        }
                      } break;
                    }
                  ...
                  case FunctionComponent: case ForwardRef: case MemoComponent: case SimpleMemoComponent: case Block: {// Layout effects are destroyed during the mutation phase so that all
                    ...
                    var instance = finishedWork.stateNode; if (instance != null) {// Commit the work prepared earlier.
                      ...
                      var updatePayload = finishedWork.updateQueue; finishedWork.updateQueue = null; if (updatePayload !== null) { commitUpdate(instance, updatePayload, type, oldProps, newProps, finishedWork); }
                    } return;
                  } case HostText: {
                ...
                var thenables = finishedWork.updateQueue; if (thenables !== null) {
                  finishedWork.updateQueue = null; var retryCache = finishedWork.stateNode; if (retryCache === null) { retryCache = finishedWork.stateNode = new PossiblyWeakSet(); } thenables.forEach(function (thenable) {// Memoize using the boundary fiber to prevent redundant listeners.
                    var retry = resolveRetryThenable.bind(null, finishedWork, thenable); if (!retryCache.has(thenable)) { { if (thenable.__reactDoNotTraceInteractions !== true) { retry = tracing$1.unstable_wrap(retry); } } retryCache.add(thenable); thenable.then(retry, retry); }
                  });
                }
              } function commitResetTextContent(current) { if (!supportsMutation) { return; } resetTextContent(current.stateNode); } var PossiblyWeakMap = typeof WeakMap === 'function' ? WeakMap : Map; function createRootErrorUpdate(fiber, errorInfo, expirationTime) {
              ...
              var currentEventTime = NoWork; function requestCurrentTimeForUpdate() {
                ...
                currentEventTime = msToExpirationTime(now$1()); return currentEventTime;
              } function getCurrentTime() { return msToExpirationTime(now$1()); } function computeExpirationForFiber(currentTime, fiber, suspenseConfig) {
                var mode = fiber.mode; if ((mode & BlockingMode) === NoMode) { return Sync; } var priorityLevel = getCurrentPriorityLevel(); if ((mode & ConcurrentMode) === NoMode) { return priorityLevel === ImmediatePriority ? Sync : Batched; } if ((executionContext & RenderContext) !== NoContext) {// Use whatever time we're already rendering
                  ...
                  switch (priorityLevel) {
                    case ImmediatePriority: expirationTime = Sync; break; case UserBlockingPriority:// TODO: Rename this to computeUserBlockingExpiration
              ...
              function performSyncWorkOnRoot(root) {// Check if there's expired work on this root. Otherwise, render at Sync.
              ...
              } function flushRoot(root, expirationTime) { markRootExpiredAtTime(root, expirationTime); ensureRootIsScheduled(root); if ((executionContext & (RenderContext | CommitContext)) === NoContext) { flushSyncCallbackQueue(); } } function flushDiscreteUpdates() {// TODO: Should be able to flush inside batchedUpdates, but not inside `act`.
                ...
                flushPassiveEffects();
              } function deferredUpdates(fn) {// TODO: Remove in favor of Scheduler.next
                return runWithPriority(NormalPriority, fn);
              } function syncUpdates(fn, a, b, c) { return runWithPriority(ImmediatePriority, fn.bind(null, a, b, c)); } function flushPendingDiscreteUpdates() {
                ...
                if ((executionContext & (RenderContext | CommitContext)) !== NoContext) { { { throw Error("flushSync was called from inside a lifecycle method. It cannot be called when React is already rendering."); } } } var prevExecutionContext = executionContext; executionContext |= BatchedContext; try { return runWithPriority(ImmediatePriority, fn.bind(null, a)); } finally {
                ...
                var prevExecutionContext = executionContext; executionContext |= BatchedContext; try { runWithPriority(ImmediatePriority, fn); } finally {
                  executionContext = prevExecutionContext; if (executionContext === NoContext) {// Flush the immediate callbacks that were scheduled during this batch
                    flushSyncCallbackQueue();
                  }
                }
              ...
              } function popDispatcher(prevDispatcher) { ReactCurrentDispatcher$1.current = prevDispatcher; } function pushInteractions(root) { { var prevInteractions = tracing$1.__interactionsRef.current; tracing$1.__interactionsRef.current = root.memoizedInteractions; return prevInteractions; } } function popInteractions(prevInteractions) { { tracing$1.__interactionsRef.current = prevInteractions; } } function markCommitTimeOfFallback() { globalMostRecentFallbackTime = now$1(); } function markRenderEventTimeAndConfig(expirationTime, suspenseConfig) {
...
/** @noinline */function workLoopSync() {// Already timed out, so perform work without checking if we need to yield.
              ...
              } function commitRoot(root) { var renderPriorityLevel = getCurrentPriorityLevel(); runWithPriority(ImmediatePriority, commitRootImpl.bind(null, root, renderPriorityLevel)); return null; } function commitRootImpl(root, renderPriorityLevel) {
              ...
              function warnIfUnmockedScheduler(fiber) { { if (didWarnAboutUnmockedScheduler === false && Scheduler.unstable_flushAllWithoutAsserting === undefined) { if (fiber.mode & BlockingMode || fiber.mode & ConcurrentMode) { didWarnAboutUnmockedScheduler = true; error('In Concurrent or Sync modes, the "scheduler" module needs to be mocked ' + 'to guarantee consistent behaviour across tests and browsers. ' + 'For example, with jest: \n' + "jest.mock('scheduler', () => require('scheduler/unstable_mock'));\n\n" + 'For more info, visit https://fb.me/react-mock-scheduler'); } } } } function computeThreadID(root, expirationTime) {// Interaction threads are unique per root and expiration time.
                ...
                if (interactions.size > 0) {
                  ...
                  } var subscriber = tracing$1.__subscriberRef.current; if (subscriber !== null) { var threadID = computeThreadID(root, expirationTime); subscriber.onWorkScheduled(interactions, threadID); }
                }
              } function schedulePendingInteractions(root, expirationTime) { scheduleInteractions(root, expirationTime, tracing$1.__interactionsRef.current); } function startWorkOnPendingInteractions(root, expirationTime) {// we can accurately attribute time spent working on it, And so that cascading
                ...
                root.memoizedInteractions = interactions; if (interactions.size > 0) {
                  var subscriber = tracing$1.__subscriberRef.current; if (subscriber !== null) {
              ...
              } function markRootExpiredAtTime(root, expirationTime) { var lastExpiredTime = root.lastExpiredTime; if (lastExpiredTime === NoWork || lastExpiredTime > expirationTime) { root.lastExpiredTime = expirationTime; } } var didWarnAboutMessageChannel = false; var enqueueTaskImpl = null; function enqueueTask(task) {
                if (enqueueTaskImpl === null) {
                  try {// read require off the module object to get around the bundlers.
              ...
              } function getPublicRootInstance(container) { var containerFiber = container.current; if (!containerFiber.child) { return null; } switch (containerFiber.child.tag) { case HostComponent: return getPublicInstance(containerFiber.child.stateNode); default: return containerFiber.child.stateNode; } } function attemptSynchronousHydration(fiber) {
                switch (fiber.tag) {
                  case HostRoot: var root = fiber.stateNode; if (root.hydrate) {// Flush the first scheduled "update".
                    flushRoot(root, root.firstPendingTime);
                  } break; case SuspenseComponent: flushSync(function () { return scheduleWork(fiber, Sync); });// If we're still blocked after this, we need to increase
                    // the priority of any promises resolving within this
                    // boundary so that they next attempt also has higher pri.
                    var retryExpTime = computeInteractiveExpiration(requestCurrentTimeForUpdate()); markRetryTimeIfNotHydrated(fiber, retryExpTime); break;
                }
              } function markRetryTimeImpl(fiber, retryTime) { var suspenseState = fiber.memoizedState; if (suspenseState !== null && suspenseState.dehydrated !== null) { if (suspenseState.retryTime < retryTime) { suspenseState.retryTime = retryTime; } } }// Increases the priority of thennables when they resolve within this boundary.
              function markRetryTimeIfNotHydrated(fiber, retryTime) { markRetryTimeImpl(fiber, retryTime); var alternate = fiber.alternate; if (alternate) { markRetryTimeImpl(alternate, retryTime); } } function attemptUserBlockingHydration(fiber) {
              ...
              var actingUpdatesScopeDepth = 0; function act(callback) {
                var previousActingUpdatesScopeDepth = actingUpdatesScopeDepth; var previousIsSomeRendererActing; var previousIsThisRendererActing; actingUpdatesScopeDepth++; previousIsSomeRendererActing = IsSomeRendererActing$1.current; previousIsThisRendererActing = IsThisRendererActing.current; IsSomeRendererActing$1.current = true; IsThisRendererActing.current = true; function onDone() {
                ...
                } var result; try { result = batchedUpdates(callback); } catch (error) {// on sync errors, we still want to 'cleanup' and decrement actingUpdatesScopeDepth
                  onDone(); throw error;
                } if (result !== null && _typeof(result) === 'object' && typeof result.then === 'function') {// setup a boolean that gets set to true only
                  ...
                  return {
                    then: function then(resolve, reject) {
                      called = true; result.then(function () {
                        if (actingUpdatesScopeDepth > 1 || isSchedulerMocked === true && previousIsSomeRendererActing === true) { onDone(); resolve(); return; }// we're about to exit the act() scope,
                        // now's the time to flush tasks/effects
                        flushWorkAndMicroTasks(function (err) { onDone(); if (err) { reject(err); } else { resolve(); } });
                      }, function (err) { onDone(); reject(err); });
                    }
                  };
                } else {
                  { if (result !== undefined) { error('The callback passed to act(...) function ' + 'must return undefined, or a Promise. You returned %s', result); } }// flush effects until none remain, and cleanup
                  try {
          ...
          unit: { type: 2/* INITIAL_ONLY */, initial: true }, 'activity-modifier': { type: 2/* INITIAL_ONLY */, initial: true }, map: { type: 2/* INITIAL_ONLY */, initial: true }, camera: { type: 2/* INITIAL_ONLY */, initial: true }, light: { type: 2/* INITIAL_ONLY */, initial: true }, pitchmin: createSceneRotationSetter('pitchmin'), pitchmax: createSceneRotationSetter('pitchmax'), yawmin: createSceneRotationSetter('yawmin'), yawmax: createSceneRotationSetter('yawmax'), allowrotation: { type: 2/* INITIAL_ONLY */, initial: true }, rotateonhover: { type: 2/* INITIAL_ONLY */, initial: true }, rotateonmousemove: { type: 2/* INITIAL_ONLY */, initial: true }, antialias: { type: 2/* INITIAL_ONLY */, initial: true }, panoramasurfaceheight: { type: 2/* INITIAL_ONLY */, initial: true }, panoramasurfacewidth: { type: 2/* INITIAL_ONLY */, initial: true }, panoramasurfacexml: { type: 2/* INITIAL_ONLY */, initial: true }, particleonly: { type: 2/* INITIAL_ONLY */, initial: true }, renderdeferred: { type: 2/* INITIAL_ONLY */, initial: true }, rendershadows: { type: 2/* INITIAL_ONLY */, initial: true }
        }); definePanelPropertyInformation('DOTAEconItem', { itemdef: { type: 3/* CUSTOM */, update: function update(panel, newValue) { panel._econItemDef = newValue; panel.SetItemByDefinitionAndStyle(panel._econItemDef || 0, panel._econItemStyle || 0); } }, itemstyle: { type: 3/* CUSTOM */, update: function update(panel, newValue) { panel._econItemStyle = newValue; panel.SetItemByDefinitionAndStyle(panel._econItemDef || 0, panel._econItemStyle || 0); } } }); var progressBarAttributes = { value: { type: 0/* SET */, name: 'value', initial: true }, min: { type: 0/* SET */, name: 'min', initial: true }, max: { type: 0/* SET */, name: 'max', initial: true } }; definePanelPropertyInformation('ProgressBar', progressBarAttributes); definePanelPropertyInformation('CircularProgressBar', progressBarAttributes); definePanelPropertyInformation('ProgressBarWithMiddle', { lowervalue: { type: 0/* SET */, name: 'lowervalue', initial: true }, uppervalue: { type: 0/* SET */, name: 'uppervalue', initial: true }, min: { type: 0/* SET */, name: 'min', initial: true }, max: { type: 0/* SET */, name: 'max', initial: true } }); var steamIdAttribute = {
          type: 3/* CUSTOM */, initial: true, update: function update(panel) {
            var newValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '0';// XML attribute supports "local" value, but JS setter doesn't
            if (newValue === 'local') { panel.steamid = Game.GetLocalPlayerInfo().player_steamid; } else { panel.steamid = newValue; }
          }
        }; definePanelPropertyInformation('DOTAUserName', { steamid: steamIdAttribute }); definePanelPropertyInformation('DOTAUserRichPresence', { steamid: steamIdAttribute }); definePanelPropertyInformation('DOTAAvatarImage', { steamid: steamIdAttribute, nocompendiumborder: { type: 2/* INITIAL_ONLY */, initial: true }, lazy: { type: 2/* INITIAL_ONLY */, initial: true } }); definePanelPropertyInformation('Countdown', { startTime: { type: 0/* SET */, name: 'startTime', initial: 'start-time' }, endTime: { type: 0/* SET */, name: 'endTime', initial: 'end-time' }, updateInterval: { type: 0/* SET */, name: 'updateInterval' }, timeDialogVariable: { type: 0/* SET */, name: 'timeDialogVariable' } }); definePanelPropertyInformation('TextButton', labelTextAttributes); definePanelPropertyInformation('ToggleButton', Object.assign(Object.assign({}, labelTextAttributes), { selected: { type: 0/* SET */, name: 'checked' }, html: { type: 2/* INITIAL_ONLY */, initial: true } })); definePanelPropertyInformation('RadioButton', { group: { type: 2/* INITIAL_ONLY */, initial: true }, text: { type: 2/* INITIAL_ONLY */, initial: true }, html: { type: 2/* INITIAL_ONLY */, initial: true }, selected: { type: 0/* SET */, name: 'checked' } }); definePanelPropertyInformation('TextEntry', { text: { type: 0/* SET */, name: 'text' }, multiline: { type: 2/* INITIAL_ONLY */, initial: true }, maxchars: { type: 1/* SETTER */, name: 'SetMaxChars', initial: true }, placeholder: { type: 2/* INITIAL_ONLY */, initial: true }, textmode: { type: 2/* INITIAL_ONLY */, initial: true } }); definePanelPropertyInformation('NumberEntry', {
          value: { type: 0/* SET */, name: 'value', initial: true }, increment: { type: 0/* SET */, name: 'increment', initial: true },// panel.value = panel.value refreshes increment and decrement buttons
/* eslint-disable no-self-assign */min: { type: 3/* CUSTOM */, initial: true, update: function update(panel) { var newValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0; panel.min = newValue; panel.value = panel.value; } }, max: { type: 3/* CUSTOM */, initial: true, update: function update(panel) { var newValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000000; panel.max = newValue; panel.value = panel.value; } }
        }); var sliderAttributes = {// panel.SetDirection doesn't seem to work
          direction: { type: 2/* INITIAL_ONLY */, initial: true }, value: { type: 1/* SETTER */, name: 'SetValueNoEvents' }, min: { type: 0/* SET */, name: 'min' }, max: { type: 0/* SET */, name: 'max' }
        }; definePanelPropertyInformation('Slider', sliderAttributes); definePanelPropertyInformation('SlottedSlider', Object.assign(Object.assign({}, sliderAttributes), { notches: { type: 2/* INITIAL_ONLY */, initial: true } })); definePanelPropertyInformation('DropDown', {
          selected: {
            type: 3/* CUSTOM */, update: function update(panel, newValue) {// Defer update until children are created
              queueMicrotask(function () { return newValue && panel.SetSelected(newValue); });
            }
          }
        }); definePanelPropertyInformation('Carousel', { focus: { type: 2/* INITIAL_ONLY */, initial: true }, 'focus-offset': { type: 2/* INITIAL_ONLY */, initial: true }, wrap: { type: 2/* INITIAL_ONLY */, initial: true }, selectionposboundary: { type: 2/* INITIAL_ONLY */, initial: true }, 'panels-visible': { type: 2/* INITIAL_ONLY */, initial: true }, clipaftertransform: { type: 2/* INITIAL_ONLY */, initial: true }, AllowOversized: { type: 2/* INITIAL_ONLY */, initial: true }, 'autoscroll-delay': { type: 2/* INITIAL_ONLY */, initial: true }, 'x-offset': { type: 2/* INITIAL_ONLY */, initial: true } }); definePanelPropertyInformation('CarouselNav', { carouselid: { type: 2/* INITIAL_ONLY */, initial: true } }); definePanelPropertyInformation('DOTAHUDOverlayMap', { maptexture: { type: 0/* SET */, name: 'maptexture', initial: true }, mapscale: { type: 0/* SET */, name: 'mapscale', initial: true }, mapscroll: { type: 0/* SET */, name: 'mapscroll' }, fixedoffsetenabled: { type: 0/* SET */, name: 'fixedoffsetenabled' }, fixedOffset: { type: 3/* CUSTOM */, update: function update(panel) { var newValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}; panel.SetFixedOffset(newValue.x || 0, newValue.y || 0); } }, fixedBackgroundTexturePosition: { type: 3/* CUSTOM */, update: function update(panel) { var newValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}; panel.SetFixedBackgroundTexturePosition(newValue.size || 0, newValue.x || 0, newValue.y || 0); } } }); definePanelPropertyInformation('HTML', { url: { type: 1/* SETTER */, name: 'SetURL', initial: true } }); definePanelPropertyInformation('CustomLayoutPanel', { layout: { type: 2/* INITIAL_ONLY */, initial: true } }); var genericPanelPropertyInfo = { type: 2/* INITIAL_ONLY */, initial: true }; var uiEventPropertyInfo = {
          type: 3/* CUSTOM */, update: function update(panel, newValue, _oldValue, propName) {
            var _a; (_a = panel._eventHandlers) !== null && _a !== void 0 ? _a : panel._eventHandlers = {};// eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
            if (panel._eventHandlers[propName] === undefined) { $.RegisterEventHandler(propName.slice(6), panel, function () { var _panel$_eventHandlers; return (_panel$_eventHandlers = panel._eventHandlers)[propName].apply(_panel$_eventHandlers, arguments); }); } panel._eventHandlers[propName] = newValue !== undefined ? newValue : noop;
          }
        }; var panelEventPropertyInfo = {
          type: 3/* CUSTOM */, update: function update(panel, newValue, _oldValue, propName) {
            var _a;// Unlike UI event handlers, it's not required to use an object here,
            ...
            if (panel._eventHandlers[propName] === undefined) { panel.SetPanelEvent(propName, function () { return panel._eventHandlers[propName](panel); }); } panel._eventHandlers[propName] = newValue !== undefined ? newValue : noop;
          }
        }; function getPropertyInfo(type, propName) {
          var _a; var propertyInformation = propertiesInformation[propName]; if (// eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
            propertyInformation !== undefined && !(panelBaseNames.has(type) && propertyInformation.type === 0/* SET */)) { return propertyInformation; } var panelProperty = (_a = panelPropertyInformation[type]) === null || _a === void 0 ? void 0 : _a[propName]; if (panelProperty) return panelProperty; if (propName === 'children') return undefined; if (propName.startsWith('on-ui-')) return uiEventPropertyInfo; if (propName.startsWith('on')) return panelEventPropertyInfo; if (type === 'GenericPanel') return genericPanelPropertyInfo;
          ...
          var propertyInformation = getPropertyInfo(type, propName); if (!propertyInformation) {// Ignore unknown properties
            return;
          } if (panelBaseNames.has(type) && propertyInformation.throwOnIncomplete) { throw new Error("Attribute \"".concat(propName, "\" cannot be ").concat(propertyInformation.initial ? 'changed on' : 'added to', " incomplete ").concat(type, " panel type.").concat(propertyInformation.initial ? ' Add a "key" attribute to force re-mount.' : '')); } switch (propertyInformation.type) { case 0/* SET */: panel[propertyInformation.name] = newValue; break; case 1/* SETTER */: panel[propertyInformation.name](newValue); break; case 2/* INITIAL_ONLY */: throw new Error("Attribute \"".concat(propName, "\" cannot be changed. Add a \"key\" attribute to force re-mount.")); case 3/* CUSTOM */: propertyInformation.update(panel, newValue, oldValue, propName); break; }
        } var rootHostContext = {}; var childHostContext = {}; function appendChild(parent, child) { if (parent.paneltype === 'DropDown') { parent.AddOption(child); return; } if (parent.paneltype === 'ContextMenuScript') { parent = parent.GetContentsPanel(); } if (parent === child.GetParent()) { parent.MoveChildAfter(child, parent.GetChild(parent.GetChildCount() - 1)); } else { child.SetParent(parent); } } function insertBefore(parent, child, beforeChild) { if (parent.paneltype === 'DropDown') { parent.AddOption(child); parent.AccessDropDownMenu().MoveChildBefore(child, beforeChild); return; } if (parent.paneltype === 'ContextMenuScript') { parent = parent.GetContentsPanel(); } child.SetParent(parent); parent.MoveChildBefore(child, beforeChild); } function removeChild(parent, child) {
          if (parent.paneltype === 'DropDown') { parent.RemoveOption(child.id); } else {
            child.SetParent(temporaryPanelHost); temporaryPanelHost.RemoveAndDeleteChildren();// TODO: child.DeleteAsync(0)?
          }
        } var hostConfig = {
          getPublicInstance: function getPublicInstance(instance) { return instance; }, getRootHostContext: function getRootHostContext() { return rootHostContext; }, getChildHostContext: function getChildHostContext() { return childHostContext; }, prepareForCommit: noop, resetAfterCommit: noop,// https://github.com/facebook/react/pull/14984
          scheduleDeferredCallback: undefined, cancelDeferredCallback: undefined,// https://github.com/facebook/react/pull/19124
          shouldDeprioritizeSubtree: undefined, setTimeout: setTimeout, clearTimeout: clearTimeout, noTimeout: -1, now: Date.now, isPrimaryRenderer: true, supportsMutation: true, supportsPersistence: false, supportsHydration: false, shouldSetTextContent: function shouldSetTextContent() { return false; }, createInstance: function createInstance(type, newProps) {
            var _splitInitialProps = splitInitialProps(type, newProps), initialProps = _splitInitialProps.initialProps, otherProps = _splitInitialProps.otherProps; if (type === 'GenericPanel') type = newProps.type; var panel = initialProps ?// Create it on the context panel instead of rootContainerInstance to
              // preserve style context for elements rendered outside of the main tree
              $.CreatePanelWithProperties(type, $.GetContextPanel(), newProps.id || '', initialProps) : $.CreatePanel(type, $.GetContextPanel(), newProps.id || ''); if (panelBaseNames.has(type)) { fixPanelBase(panel); } for (var propName in otherProps) { updateProperty(type, panel, propName, undefined, otherProps[propName]); } return panel;
          }, createTextInstance: function createTextInstance() { throw new Error('react-panorama does not support text nodes. Use <Label /> element instead.'); }, appendInitialChild: appendChild, finalizeInitialChildren: function finalizeInitialChildren() { return false; }, appendChild: appendChild, appendChildToContainer: appendChild, insertBefore: insertBefore, insertInContainerBefore: insertBefore, removeChild: removeChild, removeChildFromContainer: removeChild,// https://github.com/facebook/react/pull/8607
 ...
 */function render(element, container, callback) {
          var _a; var panel = container; if (panel._reactPanoramaSymbol !== reactPanoramaSymbol) {
            panel._reactPanoramaSymbol = reactPanoramaSymbol;// Container was used in the previous reload cycle
            panel._rootContainer = undefined;
          } (_a = panel._rootContainer) !== null && _a !== void 0 ? _a : panel._rootContainer = reconciler.createContainer(panel, false, false);// @ts-expect-error callback type should be nullable
...
/* harmony import */ var react_panorama__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-panorama */ "../../../../../node_modules/react-panorama/dist/esm/react-panorama.development.js");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/utils */ "./utils/utils.ts");
          ...
          return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "StorePage", className: "DotaPlusContainer", ref: storePage },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "SearchAndCategoriesContainer" },
              ...
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "SearchCategories" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "TabButton", id: "CategoryAll", selected: true, className: "SearchCategory", group: "search_categories" },
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryBackground" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryArtOverlay" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryText" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryName", text: "#CategoryAll" }),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryDetails", text: "#CategoryAll_Description" }))),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "TabButton", id: "CategoryHero", className: "SearchCategory", group: "search_categories" },
                  ...
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryArtOverlay" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryText" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryName", text: "#CategoryHero" }),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryDetails", text: "#CategoryHero_Description" }))),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "TabButton", id: "CategorySkin", className: "SearchCategory", group: "search_categories" },
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryBackground" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryArtOverlay" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryText" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryName", text: "#CategorySkin" }),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryDetails", text: "#CategorySkin_Description" }))),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "TabButton", id: "CategoryParticle", className: "SearchCategory", group: "search_categories" },
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryBackground" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryArtOverlay" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryText" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryName", text: "#CategoryParticle" }),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryDetails", text: "#CategoryParticle_Description" }))),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "TabButton", id: "CategoryPet", className: "SearchCategory", group: "search_categories" },
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryBackground" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryArtOverlay" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryText" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryName", text: "#CategoryPet" }),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { className: "SearchCategoryDetails", text: "#CategoryPet_Description" }))),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "TabButton", id: "CategoryGamePlay", className: "SearchCategory", group: "search_categories" },
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryBackground" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryArtOverlay" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "SearchCategoryText" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "StoreTabContents" },
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(StoreItemContainer, { word: filterWord, tabid: "CategoryAll", type: "all" }),
        ...
        function StoreItemContainer({ word, tabid, type }) {
          ...
          return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(GenericPanel, { type: "TabContents", tabid: tabid, group: "search_categories", className: "StoreItemContainer", selected: tabid == "CategoryAll" ? true : false },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "StoreHeader" },
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { localizedText: tabid }),
        ...
        function StoreItem({ itemData }) {
          let ShowCourierTooltip = (self) => {
            if (itemData.Type == "pet") {
              $.DispatchEvent("UIShowCustomLayoutParametersTooltip", self, "courier_tooltip", "file://{resources}/layout/custom_game/tooltips/courier/courier.xml", "courier_name=" + itemData.ItemName + "&rotationspeed=2");
            }
          };
          let HideCourierTooltip = (self) => {
            if (itemData.Type == "pet") {
              $.DispatchEvent("UIHideCustomLayoutTooltip", self, "courier_tooltip");
            }
          };
          let ShowItemDetail = (self) => {
            (0, _utils_utils__WEBPACK_IMPORTED_MODULE_3__.OpenPopup)("popup_store_item/popup_store_item", { itemData: JSON.stringify(itemData) });
          };
          return (react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("AthenaStoreItem", { HeroItem: itemData.Type == "hero" }, { HeroItem: itemData.Type == "skin" }, { Prefab_courier: itemData.Type == "pet" }, { Prefab_ward: itemData.Type == "particle" }, { Prefab_bundle: itemData.Type == "gameplay" }), onmouseover: ShowCourierTooltip, onmouseout: HideCourierTooltip, onactivate: ShowItemDetail },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "ItemImageContainer" },
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(Image, { id: "ItemImage", scaling: "stretch-to-fit-preserve-aspect", src: "file://{images}/custom_game/" + itemData.Type + "/" + itemData.ItemName + ".png" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "SkillPreview" }))),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "ItemName", localizedText: itemData.Type == "hero" ? "npc_dota_hero_" + itemData.ItemName : itemData.ItemName }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "ItemType" },
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "UnitIcon" },
                itemData.Type == "hero" &&
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(DOTAHeroImage, { id: "HeroIcon", heroimagestyle: "icon", heroname: "npc_dota_hero_" + itemData.ItemName, scaling: "stretch-to-fit-preserve-aspect" }),
                itemData.Type == "skin" &&
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(DOTAHeroImage, { id: "HeroIcon", heroimagestyle: "icon", heroname: GameUI.CustomUIConfig().PlayerItemsKV[itemData.ItemName].Hero, scaling: "stretch-to-fit-preserve-aspect" }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "ItemTypeIcon" })),
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "ItemTypeLabel", text: "StoreItemType_" + itemData.Type })),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { className: "PurchaseButtonList" },
              itemData.Shard > 0 &&
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { id: "ShardPurchaseButton", className: "DotaPlusPurchaseButton" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "Contents", className: "ButtonCenter" },
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "EventIcon", className: "DotaPlusCurrencyIcon" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "ShardCost", text: itemData.Shard }))),
              itemData.Price > 0 &&
              react__WEBPACK_IMPORTED_MODULE_1__.createElement(Button, { id: "PricePurchaseButton", className: "DotaPlusPurchaseButton" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "Contents", className: "ButtonCenter" },
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Panel, { id: "EventIcon", className: "DotaPlusPriceCurrencyIcon" }),
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Label, { id: "PriceCost", text: itemData.Price }))))));
        }
        (0, react_panorama__WEBPACK_IMPORTED_MODULE_2__.render)(react__WEBPACK_IMPORTED_MODULE_1__.createElement(Store, null), $.GetContextPanel());
