...
function StoreItem({ itemData, playerData }) {
    ...
    let ShowItemDetail = (self) => {
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.OpenPopup)("popup_inventory_item/popup_inventory_item", { itemData: JSON.stringify(itemData) });
    };
...
(0,_demon673_react_panorama__WEBPACK_IMPORTED_MODULE_2__.render)(react__WEBPACK_IMPORTED_MODULE_1__.createElement(Inventory, null), $.GetContextPanel());
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./inventory/script.tsx");
